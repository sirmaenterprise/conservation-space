 ...
 */
public class NameIDMappingServiceSchemaTest extends EndpointSchemaTestBase {

    /** Constructor */
    public NameIDMappingServiceSchemaTest() {
        targetQName = new QName(SAMLConstants.SAML20MD_NS, NameIDMappingService.DEFAULT_ELEMENT_LOCAL_NAME,
                SAMLConstants.SAML20MD_PREFIX);
        validator = new NameIDMappingServiceSchemaValidator();
    }
}