...
/**
 * Builder of {@link org.opensaml.xml.signature.X509IssuerName}
 */
public class X509IssuerNameBuilder extends AbstractXMLObjectBuilder<X509IssuerName> implements XMLSignatureBuilder<X509IssuerName> {
    ...
    public X509IssuerName buildObject() {
        return buildObject(XMLConstants.XMLSIG_NS, X509IssuerName.DEFAULT_ELEMENT_LOCAL_NAME, XMLConstants.XMLSIG_PREFIX);
    }
