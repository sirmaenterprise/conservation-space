...
/**
 * Builder of {@link org.opensaml.xml.signature.X509IssuerSerial}
 */
public class X509IssuerSerialBuilder extends AbstractXMLObjectBuilder<X509IssuerSerial> implements XMLSignatureBuilder<X509IssuerSerial> {
    ...
    public X509IssuerSerial buildObject() {
        return buildObject(XMLConstants.XMLSIG_NS, X509IssuerSerial.DEFAULT_ELEMENT_LOCAL_NAME, XMLConstants.XMLSIG_PREFIX);
    }
