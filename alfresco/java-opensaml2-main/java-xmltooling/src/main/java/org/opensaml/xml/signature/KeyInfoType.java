...
public interface KeyInfoType extends ValidatingXMLObject {
     ...
     * 
     * Note: AgreementMethod is actually defined in the XML Encryption schema,
     * and is not explicitly defined in the KeyInfoType content model,
     * but for convenience this named getter method is exposed.
     * 
     ...
     * 
     * Note: EncryptedKey is actually defined in the XML Encryption schema,
     * and is not explicitly defined in the KeyInfoType content model,
     * but for convenience this named getter method is exposed.
     * 
