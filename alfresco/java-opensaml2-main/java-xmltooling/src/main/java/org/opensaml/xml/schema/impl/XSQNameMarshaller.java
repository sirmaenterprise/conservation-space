...
/**
 * A thread-safe marshaller for {@link org.opensaml.xml.schema.XSQName}s.
 */
public class XSQNameMarshaller extends AbstractXMLObjectMarshaller {
    
    /** Constructor. */
    public XSQNameMarshaller() {
        super();
    }
     ...
     *            marshaller operates on
     */
    protected XSQNameMarshaller(String targetNamespaceURI, String targetLocalName) {
