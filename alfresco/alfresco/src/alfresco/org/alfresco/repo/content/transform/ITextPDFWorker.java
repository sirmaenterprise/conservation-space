...
public class ITextPDFWorker {
	 ...
	 *
	 * @param text is the input stream - should character stream
	 * @param encoding the encoding
	 * @param output is the output stream to store pdf in
	 * @return the created pdf or null on exception
	 * @throws DocumentException on error while adding data
