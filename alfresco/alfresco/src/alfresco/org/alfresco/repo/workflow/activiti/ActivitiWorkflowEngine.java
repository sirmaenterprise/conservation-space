...
public class ActivitiWorkflowEngine extends BPMEngine implements WorkflowEngine {
	 ...
	 * 
	 * @see
	 * org.alfresco.repo.workflow.WorkflowComponent#cancelWorkflows(java.util
	 * .List)
	 */
	@Override
	 ...
	 * @param definitions
	 *            the definitions
	 * @return the valid workflow definitions {@link WorkflowDefinition}s that
	 *         have a valid domain.
	 */
	 ...
	 * @param tasks
	 *            the tasks
	 * @return the valid workflow tasks {@link WorkflowTask}s that have a valid
	 *         domain.
	 */
	 ...
	 * @param tasks
	 *            the tasks
	 * @return the valid historic tasks {@link WorkflowTask}s that have a valid
	 *         domain.
	 */
		...
		if (!Boolean.FALSE.equals(query.isActive())) {
			...
			if (getWorkflowReportService() != null) {
				for (WorkflowTask workflowTask : validWorkflowTasks) {
					getWorkflowReportService().createIfNotExists(workflowTask);
				}
			}
	 ...
	 * 
	 * @see
	 * org.alfresco.repo.workflow.TaskComponent#getStartTasks(java.util.List,
	 * boolean)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.alfresco.repo.workflow.WorkflowComponent#getWorkflows(org.alfresco
	...
	public void setWorkflowReportService(WorkflowReportService workflowReportService) {
