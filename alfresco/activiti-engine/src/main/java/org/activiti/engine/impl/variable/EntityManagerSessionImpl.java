...
/**
 * The Class EntityManagerSessionImpl.
 *
...
public class EntityManagerSessionImpl implements EntityManagerSession {
  ...
  /**
   * Instantiates a new entity manager session impl.
   *
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.EntityManagerSession#getEntityManager()
   */
