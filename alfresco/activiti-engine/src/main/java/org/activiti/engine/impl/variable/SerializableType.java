...
public class SerializableType extends ByteArrayType {
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.ByteArrayType#getTypeName()
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.ByteArrayType#getValue(org.activiti.engine.impl.variable.ValueFields)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.ByteArrayType#setValue(java.lang.Object, org.activiti.engine.impl.variable.ValueFields)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.ByteArrayType#isAbleToStore(java.lang.Object)
   */
