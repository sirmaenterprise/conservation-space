...
/**
 * The Class DbUpgradeStep52To53InsertPropertyHistoryLevel.
 *
 * @author Tom Baeyens
 */
public class DbUpgradeStep52To53InsertPropertyHistoryLevel implements DbUpgradeStep {
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.db.upgrade.DbUpgradeStep#execute(org.activiti.engine.impl.db.DbSqlSession)
   */
