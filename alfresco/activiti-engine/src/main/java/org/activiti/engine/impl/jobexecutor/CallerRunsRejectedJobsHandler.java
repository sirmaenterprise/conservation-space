...
/**
 * The Class CallerRunsRejectedJobsHandler.
 *
 * @author Daniel Meyer
 */
public class CallerRunsRejectedJobsHandler implements RejectedJobsHandler {
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.jobexecutor.RejectedJobsHandler#jobsRejected(org.activiti.engine.impl.jobexecutor.JobExecutor, java.util.List)
   */
