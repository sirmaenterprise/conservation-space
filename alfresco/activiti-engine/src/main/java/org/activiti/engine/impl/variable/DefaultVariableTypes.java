...
/**
 * The Class DefaultVariableTypes.
 *
 * @author Tom Baeyens
 */
public class DefaultVariableTypes implements Serializable, VariableTypes {
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.VariableTypes#addType(org.activiti.engine.impl.variable.VariableType)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.VariableTypes#addType(org.activiti.engine.impl.variable.VariableType, int)
   */
   ...
   * Sets the types list.
   *
   * @param typesList the new types list
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.VariableTypes#getVariableType(java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.VariableTypes#findVariableType(java.lang.Object)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.VariableTypes#getTypeIndex(org.activiti.engine.impl.variable.VariableType)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.VariableTypes#getTypeIndex(java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.variable.VariableTypes#removeType(org.activiti.engine.impl.variable.VariableType)
   */
