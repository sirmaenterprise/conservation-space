...
/**
 * The Class SetProcessDefinitionVersionCmd.
 *
...
public class SetProcessDefinitionVersionCmd implements Command<Void>, Serializable {
  ...
  /**
   * Instantiates a new sets the process definition version cmd.
   *
  ...
  /**
   * Validate and switch version of execution.
   *
   * @param execution the execution
   * @param newProcessDefinition the new process definition
   */
