...
/**
 * The Class ActivateProcessDefinitionCmd.
 *
 * @author Daniel Meyer
 */
public class ActivateProcessDefinitionCmd extends AbstractSetProcessDefinitionStateCmd {
  ...
  /**
   * Instantiates a new activate process definition cmd.
   *
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.cmd.AbstractSetProcessDefinitionStateCmd#setState(org.activiti.engine.impl.persistence.entity.ProcessDefinitionEntity)
   */
