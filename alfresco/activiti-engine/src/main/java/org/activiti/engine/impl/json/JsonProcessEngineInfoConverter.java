...
/**
 * The Class JsonProcessEngineInfoConverter.
 *
 * @author Tom Baeyens
 */
public class JsonProcessEngineInfoConverter extends JsonObjectConverter<ProcessEngineInfo> {
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.json.JsonObjectConverter#toJsonObject(java.lang.Object)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.json.JsonObjectConverter#toObject(java.io.Reader)
   */
