...
public class NumberOperations {
	...
	/**
	 * Checks if is float or double.
	 *
	 * @param value the value
	 * @return true, if is float or double
	 */
	...
	/**
	 * Checks if is float or double or dot ee.
	 *
	 * @param value the value
	 * @return true, if is float or double or dot ee
	 */
	...
	/**
	 * Checks if is big decimal or big integer.
	 *
	 * @param value the value
	 * @return true, if is big decimal or big integer
	 */
	...
	/**
	 * Checks if is big decimal or float or double or dot ee.
	 *
	 * @param value the value
	 * @return true, if is big decimal or float or double or dot ee
	 */
