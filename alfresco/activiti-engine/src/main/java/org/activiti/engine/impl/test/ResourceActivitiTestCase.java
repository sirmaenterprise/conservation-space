...
/**
 * The Class ResourceActivitiTestCase.
 *
 * @author Tom Baeyens
 */
public class ResourceActivitiTestCase extends AbstractActivitiTestCase {
  
  /** The cached process engines. */
  protected static Map<String, ProcessEngine> cachedProcessEngines = new HashMap<String, ProcessEngine>();
  
  /** The activiti configuration resource. */
  protected String activitiConfigurationResource;
  
  /**
   * Instantiates a new resource activiti test case.
   *
   * @param activitiConfigurationResource the activiti configuration resource
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.test.AbstractActivitiTestCase#initializeProcessEngine()
   */
  @Override
