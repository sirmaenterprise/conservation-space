...
public class ErrorPropagation {
  ...
  /**
   * Execute catch in super process.
   *
   * @param errorCode the error code
   * @param superExecution the super execution
   */
   ...
   * Execute catch.
   *
   * @param errorHandlerId the error handler id
   * @param execution the execution
   */
   ...
   *
   * @param borderEventActivity the border event activity
   * @param leavingExecution the leaving execution
   */
