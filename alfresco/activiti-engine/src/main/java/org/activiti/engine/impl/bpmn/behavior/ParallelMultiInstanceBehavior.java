...
/**
 * The Class ParallelMultiInstanceBehavior.
 *
 * @author Joram Barrez
 */
public class ParallelMultiInstanceBehavior extends MultiInstanceActivityBehavior {
  ...
  /**
   * Instantiates a new parallel multi instance behavior.
   *
   * @param activity the activity
   * @param originalActivityBehavior the original activity behavior
   */
