...
/**
 * The Class CompensationEventHandler.
 *
 * @author Daniel Meyer
 */
public class CompensationEventHandler implements EventHandler {
  
  /** The Constant EVENT_HANDLER_TYPE. */
  public final static String EVENT_HANDLER_TYPE = "compensate";

  /* (non-Javadoc)
   * @see org.activiti.engine.impl.event.EventHandler#getEventHandlerType()
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.event.EventHandler#handleEvent(org.activiti.engine.impl.persistence.entity.EventSubscriptionEntity, java.lang.Object, org.activiti.engine.impl.interceptor.CommandContext)
   */
