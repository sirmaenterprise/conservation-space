...
public abstract class ExpressionFactory {
	 ...
	 *
	 * @param context The EL context used to parse the expression. The FunctionMapper and VariableMapper
	 ...
	 * @param expectedReturnType The expected return type for the method to be found. After evaluating the
	 ...
	 * @param expectedParamTypes The expected parameter types for the method to be found. Must be an array with no
