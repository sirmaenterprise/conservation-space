...
public class AbstractBpmnActivityBehavior extends FlowNodeActivityBehavior {
  ...
  /** The multi instance activity behavior. */
  ...
  /**
   * Checks for compensation handler.
   *
   * @param execution the execution
  ...
  /**
   * Creates the compensate event subscription.
   *
   * @param execution the execution
   */
  ...
  /**
   * Checks for loop characteristics.
   *
   * @return true, if successful
   */
  ...
  /**
   * Checks for multi instance characteristics.
   *
   * @return true, if successful
   */
  ...
  /**
   * Gets the multi instance activity behavior.
   *
   * @return the multi instance activity behavior
   */
  ...
  /**
   * Sets the multi instance activity behavior.
   *
   * @param multiInstanceActivityBehavior the new multi instance activity behavior
   */
