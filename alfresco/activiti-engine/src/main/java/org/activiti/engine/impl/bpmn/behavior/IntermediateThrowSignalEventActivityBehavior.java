...
/**
 * The Class IntermediateThrowSignalEventActivityBehavior.
 *
 * @author Daniel Meyer
 */
public class IntermediateThrowSignalEventActivityBehavior extends AbstractBpmnActivityBehavior {    
  ...
  /**
   * Instantiates a new intermediate throw signal event activity behavior.
   *
   * @param signalDefinition the signal definition
   */
