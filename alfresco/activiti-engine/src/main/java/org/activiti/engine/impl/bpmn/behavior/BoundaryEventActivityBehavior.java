...
/**
 * The Class BoundaryEventActivityBehavior.
 *
 * @author Joram Barrez
 */
public class BoundaryEventActivityBehavior extends FlowNodeActivityBehavior {
  ...
  /**
   * Instantiates a new boundary event activity behavior.
   */
  ...
  /**
   * Checks if is interrupting.
   *
   * @return true, if is interrupting
   */
   ...
   *
   * @param interrupting the new interrupting
   */
