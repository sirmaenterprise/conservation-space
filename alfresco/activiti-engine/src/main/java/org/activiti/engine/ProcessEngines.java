...
public abstract class ProcessEngines {
  ...
  /**
   * Inits the process engine from spring resource.
   *
  ...
  /**
   * Inits the process engin from resource.
   *
   ...
   *
   * @return the process engine infos
   */
  ...
  /**
   * Gets the default process engine.
   *
