...
public class IdentityInfoManager extends AbstractManager {
  ...
  /**
   * Delete user info by user id and key.
   *
  ...
  /**
   * Find user account by user id and key.
   *
   * @param userId the user id
   ...
   *
   * @param identityInfoId the identity info id
   * @return the list
   */
   ...
   *
   * @param identityInfoEntity the identity info entity
   * @param accountDetails the account details
   * @param keys the keys
   */
