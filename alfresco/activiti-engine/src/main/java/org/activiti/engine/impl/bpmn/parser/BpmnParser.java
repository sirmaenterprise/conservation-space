...
public class BpmnParser extends Parser {
  ...
  /**
   * Instantiates a new bpmn parser.
   *
  ...
  /**
   * Gets the parses the listeners.
   *
   * @return the parses the listeners
   */
  ...
  /**
   * Sets the parses the listeners.
   *
   * @param parseListeners the new parses the listeners
   */
