...
public class ExecutionEntity extends VariableScopeImpl implements ActivityExecution, ExecutionListenerExecution, Execution, PvmExecution, ProcessInstance, InterpretableExecution, PersistentObject {
  ...
  /** persisted reference to the current position in the diagram within the. {@link #processDefinition}. @see #activity @see #setActivity(ActivityImpl) @see #getActivity() */
  ...
  /** persisted reference to the super execution of this execution. @See {@link #getSuperExecution()} @see #setSuperExecution(ExecutionEntity) */
  ...
  /**
   * Instantiates a new execution entity.
   */
   ...
   * Instantiates a new execution entity.
   *
   * @param activityImpl the activity impl
   */
  ...
  /**
   * Gets the all child executions.
   *
   * @return the all child executions
   */
  ...
  /**
   * All executions in same activity.
   *
  ...
  /**
   * Ensure process instance initialized.
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.pvm.runtime.InterpretableExecution#setProcessInstance(org.activiti.engine.impl.pvm.runtime.InterpretableExecution)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.pvm.runtime.InterpretableExecution#setActivity(org.activiti.engine.impl.pvm.process.ActivityImpl)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.pvm.runtime.InterpretableExecution#setParent(org.activiti.engine.impl.pvm.runtime.InterpretableExecution)
   */
  ...
  /**
   * Removes the event subscriptions.
   *
   * @param list the list
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.persistence.entity.VariableScopeImpl#initializeActivityInstanceId(org.activiti.engine.impl.persistence.entity.HistoricVariableUpdateEntity)
   */
  @Override
  ...
  /**
   * Gets the event subscriptions internal.
   *
   * @return the event subscriptions internal
   */
  ...
  /**
   * Gets the compensate event subscriptions.
   *
   * @return the compensate event subscriptions
   */
  ...
  /**
   * Ensure event subscriptions initialized.
   */
   ...
   *
   * @param eventSubscriptionEntity the event subscription entity
   */
  ...
  /**
   * Gets the jobs internal.
   *
   * @return the jobs internal
   */
  ...
  /**
   * Gets the tasks internal.
   *
   * @return the tasks internal
   */
  ...
  /**
   * Sets the cached entity state.
   *
   * @param cachedEntityState the new cached entity state
   */
  ...
  /**
   * Gets the cached entity state.
   *
   * @return the cached entity state
   */
  ...
  /**
   * Gets the transition being taken.
   *
   * @return the transition being taken
   */
  ...
  /**
   * Sets the transition being taken.
   *
   * @param transitionBeingTaken the new transition being taken
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.runtime.ProcessInstance#isSuspended()
   */
