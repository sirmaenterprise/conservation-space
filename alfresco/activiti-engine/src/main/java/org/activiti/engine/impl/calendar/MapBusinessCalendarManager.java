...
public class MapBusinessCalendarManager implements BusinessCalendarManager {
  ...
  /**
   * Adds the business calendar.
   *
   * @param businessCalendarRef the business calendar ref
   * @param businessCalendar the business calendar
