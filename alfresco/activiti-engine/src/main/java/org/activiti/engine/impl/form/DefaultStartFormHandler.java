...
/**
 * The Class DefaultStartFormHandler.
 *
 * @author Tom Baeyens
 */
public class DefaultStartFormHandler extends DefaultFormHandler implements StartFormHandler {
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.form.DefaultFormHandler#parseConfiguration(org.activiti.engine.impl.util.xml.Element, org.activiti.engine.impl.persistence.entity.DeploymentEntity, org.activiti.engine.impl.persistence.entity.ProcessDefinitionEntity, org.activiti.engine.impl.bpmn.parser.BpmnParse)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.form.StartFormHandler#createStartFormData(org.activiti.engine.impl.persistence.entity.ProcessDefinitionEntity)
   */
