...
/**
 * The Class TimerCatchIntermediateEventJobHandler.
 */
public class TimerCatchIntermediateEventJobHandler implements JobHandler {
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.jobexecutor.JobHandler#getType()
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.jobexecutor.JobHandler#execute(java.lang.String, org.activiti.engine.impl.persistence.entity.ExecutionEntity, org.activiti.engine.impl.interceptor.CommandContext)
   */
