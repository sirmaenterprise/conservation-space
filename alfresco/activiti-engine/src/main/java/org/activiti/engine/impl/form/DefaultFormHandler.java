...
public class DefaultFormHandler implements FormHandler {
  ...
  /** The form property handlers. */
  protected List<FormPropertyHandler> formPropertyHandlers = new ArrayList<FormPropertyHandler>();
  
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.form.FormHandler#parseConfiguration(org.activiti.engine.impl.util.xml.Element, org.activiti.engine.impl.persistence.entity.DeploymentEntity, org.activiti.engine.impl.persistence.entity.ProcessDefinitionEntity, org.activiti.engine.impl.bpmn.parser.BpmnParse)
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.form.FormHandler#submitFormProperties(java.util.Map, org.activiti.engine.impl.persistence.entity.ExecutionEntity)
   */
  ...
  /**
   * Gets the form property handlers.
   *
   * @return the form property handlers
   */
  ...
  /**
   * Sets the form property handlers.
   *
   * @param formPropertyHandlers the new form property handlers
   */
