...
/**
 * The Class SequentialMultiInstanceBehavior.
 *
 * @author Joram Barrez
 * @author Falko Menge
 */
public class SequentialMultiInstanceBehavior extends MultiInstanceActivityBehavior {
  ...
  /**
   * Instantiates a new sequential multi instance behavior.
   *
   * @param activity the activity
   * @param innerActivityBehavior the inner activity behavior
   */
  ...
  /* (non-Javadoc)
   * @see org.activiti.engine.impl.bpmn.behavior.MultiInstanceActivityBehavior#execute(org.activiti.engine.impl.pvm.delegate.ActivityExecution)
   */
  @Override
