...
public class AstFunction extends AstRightValue implements FunctionNode {
	...
	/**
	 * Instantiates a new ast function.
	 *
	 * @param name the name
	...
	/* (non-Javadoc)
	 * @see org.activiti.engine.impl.juel.FunctionNode#getIndex()
	 */
	public int getIndex() {
		return index;
	}
	...
	/* (non-Javadoc)
	 * @see org.activiti.engine.impl.juel.FunctionNode#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.activiti.engine.impl.juel.FunctionNode#isVarArgs()
	 */
	...
	/* (non-Javadoc)
	 * @see org.activiti.engine.impl.juel.FunctionNode#getParamCount()
	 */
