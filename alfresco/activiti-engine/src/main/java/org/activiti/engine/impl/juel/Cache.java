...
public final class Cache implements TreeCache {
   ...
   * @param size maximum primary cache size
	...
	/* (non-Javadoc)
	 * @see org.activiti.engine.impl.juel.TreeCache#get(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.activiti.engine.impl.juel.TreeCache#put(java.lang.String, org.activiti.engine.impl.juel.Tree)
	 */
