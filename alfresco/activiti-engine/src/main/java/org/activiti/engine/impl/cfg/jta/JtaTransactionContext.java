...
/**
 * The Class JtaTransactionContext.
 *
 * @author Daniel Meyer
 */
public class JtaTransactionContext implements TransactionContext {
  ...
  /**
   * Instantiates a new jta transaction context.
   *
  ...
  /**
   * The Class TransactionStateSynchronization.
   */
  public static class TransactionStateSynchronization implements Synchronization {
    ...
    /**
     * Instantiates a new transaction state synchronization.
     *
