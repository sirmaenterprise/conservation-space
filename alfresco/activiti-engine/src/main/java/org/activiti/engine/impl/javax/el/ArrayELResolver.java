...
public class ArrayELResolver extends ELResolver {
	 ...
	 * @param base The array to analyze. Only bases that are a Java language array are handled by
	 * this resolver.
	 * @param property The index of the element in the array to return the acceptable type for. Will be
