...
/**
 * The Class IntermediateThrowCompensationEventActivityBehavior.
 *
 * @author Daniel Meyer
 */
public class IntermediateThrowCompensationEventActivityBehavior extends FlowNodeActivityBehavior {

  /** The compensate event definition. */
  protected final CompensateEventDefinition compensateEventDefinition;

  /**
   * Instantiates a new intermediate throw compensation event activity behavior.
   *
