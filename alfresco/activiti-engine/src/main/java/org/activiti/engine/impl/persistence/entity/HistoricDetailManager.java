...
/**
 * The Class HistoricDetailManager.
 *
 * @author Tom Baeyens
 */
public class HistoricDetailManager extends AbstractHistoricManager {
  ...
  /**
   * Delete historic detail.
   *
   * @param historicDetail the historic detail
   */
  ...
  /**
   * Delete historic details by process instance id.
   *
   ...
   *
   * @param historicVariableUpdateQuery the historic variable update query
   * @return the long
   */
  ...
  /**
   * Delete historic details by task id.
   *
