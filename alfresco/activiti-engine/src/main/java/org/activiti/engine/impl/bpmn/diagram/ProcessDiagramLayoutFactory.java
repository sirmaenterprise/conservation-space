...
public class ProcessDiagramLayoutFactory {
   ...
   * @param imageStream BPMN 2.0 diagram in PNG format (JPEG and other formats supported
   * by {@link ImageIO} may also work)
   * @return Layout of the process diagram
   * null when parameter imageStream is null
   */
...
//    listOfBounds.putAll(getElementBoundsFromBpmnDi(bpmnModel));
   ...
   * Parses the xml.
   *
   * @param bpmnXmlStream the bpmn xml stream
   * @return the document
   */
  ...
  /**
   * Gets the diagram bounds from bpmn di.
   *
   * @param bpmnModel the bpmn model
   * @return the diagram bounds from bpmn di
   */
  ...
  /**
   * Gets the diagram bounds from image.
   *
   * @param imageStream the image stream
   * @return the diagram bounds from image
   */
  ...
  /**
   * Gets the element bounds from bpmn di.
   *
   * @param bpmnModel the bpmn model
   * @return the element bounds from bpmn di
   */
   ...
   * Parses the bounds.
   *
   * @param boundsElement the bounds element
   * @return the diagram node
   */
   ...
   *
   * @param diagramBoundsImage the diagram bounds image
   * @param diagramBoundsXml the diagram bounds xml
   * @param listOfBounds the list of bounds
   * @return the map
   */
   ...
   * @param diagramBoundsImage the diagram bounds image
   * @param diagramBoundsXml the diagram bounds xml
   * @param elementBounds the element bounds
   * @return the diagram node
   */
   ...
   *
   * @param bpmnModel the bpmn model
   * @param elementBoundsFromBpmnDi the element bounds from bpmn di
   * @return the map
   */
  ...
  /**
   * Checks if is exported from adonis50.
   *
   * @param bpmnModel the bpmn model
   * @return true, if is exported from adonis50
   */
