$(function() {
		...
		$("#upload_btn").click(function() {
			var uploadForm = this.form;
			var confirmHandler = function() {
				CLS.uploadFile(uploadForm, EMF.config.baseURL + 'service/codelists/upload/overwrite','message');
			}
			CLS.confirmDialog(
					"Confirm operation",
					"All previously loaded codelists will be deleted and overwritten with the new ones. Are you sure you want to proceed with the <b>Upload</b>?",
					confirmHandler , null, 400, 200, "Yes", "No");
		});
		$("#add_btn").click(function() {
			var uploadForm = this.form;
			var confirmHandler = function() {
				CLS.uploadFile(uploadForm, EMF.config.baseURL + 'service/codelists/upload','message');
			}
			CLS.confirmDialog(
					"Confirm operation",
					"The new codelists will be added to the existing ones. Are you sure you want to proceed with the <b>Merge</b>?",
					confirmHandler , null, 400, 200, "Yes", "No");
		});
