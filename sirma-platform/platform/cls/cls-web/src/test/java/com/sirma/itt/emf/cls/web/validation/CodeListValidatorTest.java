...
public class CodeListValidatorTest {
	...
	public void testCreateCodeListMissingFields() {
		...
		assertTrue(validationResult.get("validTo") != null
				&& validationResult.get("validTo").equals("Validity end date must be greater than current date."));
	...
	public void testCreateCodeListInvalidValue() {
		...
		assertTrue(validationResult.get("value") != null
				&& validationResult.get("value").equals("Must be an integer value. No special characters allowed."));
	}
	...
	public void testCreateCodeListDuplicatedValue() {
		...
		assertTrue(!validationResult.isEmpty());
		assertTrue(validationResult.get("value") != null
				&& validationResult.get("value").equals("There is already a code list with the same ID."));
	}
	...
	public void testUpdateCodeListNotExisting() {
		...
		assertTrue(!validationResult.isEmpty());
		assertTrue(validationResult.get("value") != null
				&& validationResult.get("value").equals("There is no code list with this ID."));
	}
