...
public class SheetParserTest {
	...
	/** The code list ids. */
	String[] codeListIds = new String[] { "1", "2", "3", "4", "5", "6", "7", "101", "102", "106", "200", "208", "210",
			"215", "227", "229", "234", "237", "238" };
	 ...
	 *             if something goes wrong while persisting the codelist
	 */
	@Test
	public void testParseXLS() throws XLSValidatorException, PersisterException {
		...
		List<CodeList> codeLists = parser.parseXLS(sheet).getCodeLists();
