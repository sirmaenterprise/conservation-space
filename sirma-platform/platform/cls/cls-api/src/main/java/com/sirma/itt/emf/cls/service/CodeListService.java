...
/**
 * Interface for retrieving code lists and values based on certain search criteria.
 *
...
public interface CodeListService {
	 ...
	 * @return {@link SearchResult} containing total number of results, returned results and pagination parameters
	 */
	...
	/**
	 * Saves or updates a code list depending on the boolean flag. If the code list information is invalid an exception
	 * is thrown.
	 *
	 * @param codeList
	 *            the provided code list
	 * @param update
	 *            boolean flag specifying if the code list should be updated or new to be saved
	 * @throws CodeListException
	 *             if the information in the code list is invalid
	 */
	void saveOrUpdateCodeList(CodeList codeList, boolean update) throws CodeListException;

	/**
	 * Saves a new version of the given codeValue by saving the codevalue in the database with the applied changes and
	 * updating the last (latest validTo date) codevalues validTo date to match the new versions validFrom date.
	 *
	 * @param codeValue
