...
public interface ClsQueries {
	...
	String CLS_TRUNCATE = "truncate table cls_codelist, cls_codevalue, cls_codevaluedescription, cls_codelistdescription";
	...
	/**
	 * Get the latest codevalue from the specified code list with the specified code value value
	 */
	...
	/**
	 * Deletes the descriptions for the given code list which are in the given language.
	 */
	String DELETE_CODELIST_DESCRIPTION_BY_LANGUAGE = "DELETE FROM CodeListDescription WHERE codeid = :id AND language = :language";

	/**
	 * Deletes the descriptions for the given code value which are in the given language.
	 */
