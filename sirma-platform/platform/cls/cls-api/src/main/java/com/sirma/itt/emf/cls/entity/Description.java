...
/**
 * POJO representing a code description. Contains all common fields contained both in code lists and code values. By
 * extending {@link BaseEntity} the ID is of type Long. <br>
