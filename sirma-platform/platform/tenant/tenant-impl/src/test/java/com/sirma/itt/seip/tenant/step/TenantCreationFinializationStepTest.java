...
/**
 * Tests for {@link TenantCreationFinializationStep}
 *
 * @author BBonev
 */
public class TenantCreationFinializationStepTest {

	private static final String TENANT_ID = "tenant.com";
	@InjectMocks
	private TenantCreationFinializationStep finializationStep;
	@Mock
