...
/**
 * Template context used in {@link TemplatePreProcessor}. Wraps a {@link TemplateInstance} and additional parameters
...
public class TemplateContext extends Context<String, Object> {
	 ...
	 */
	public TemplateContext(TemplateInstance template) {
