...
public class ScriptRoleActionFilterProviderTest {
	...
	public void beforeMethod() {
		...
		when(scriptEvaluator.createScriptedPredicate("failing")).thenThrow(ScriptException.class);
	...
	private void mockDefinition(String scriptId) {
		...
		when(dictionaryService.getAllDefinitions(any(Class.class))).thenReturn(Arrays.asList(definitionMock));
	}
