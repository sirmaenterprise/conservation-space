...
public class EntityPermissionDaoTest {
	...
	public void shouldFetchTheWholeHierarchyWithLibrariesAndAssignments() {
		List<Object[]> permissions = new ArrayList<>();
		permissions.add(new Object[] { "o1", null, (short) 2, "l1", (short) 1 });
		permissions.add(new Object[] { "o2", "o1", (short) 1, "l2", (short) 1 });
		permissions.add(new Object[] { "l1", null, (short) 2, null, (short) 2 });
		permissions.add(new Object[] { "l2", null, (short) 2, null, (short) 2 });
	...
	public void shouldPreventHierarchyLoops() {
		List<Object[]> permissions = new ArrayList<>();
		permissions.add(new Object[] { "o1", "o2", (short) 1, "l1", (short) 1 });
		permissions.add(new Object[] { "o2", "o1", (short) 1, "l2", (short) 1 });
		permissions.add(new Object[] { "l1", null, (short) 2, null, (short) 2 });
		permissions.add(new Object[] { "l2", null, (short) 2, null, (short) 2 });
	...
	public void fetchHierarchyWithAssignmentsForInstances_permissionFetched_expectedNotEmptyMap() {
		List<Object[]> permissions = new ArrayList<>();
		permissions.add(new Object[] { "instance-id", null, (short) 2, "library-id", (short) 1 });
		permissions.add(new Object[] { "library-id", null, (short) 2, null, (short) 2 });
		permissions.add(new Object[] { "instance-id-2", null, (short) 2, null, (short) 2 });
