...
public class WidgetConfigurationTest {
	...
	public void widgetConfigurationConstructor_stringConfig() throws IOException {
		try (InputStream stream = WidgetConfiguration.class
				.getClassLoader()
					.getResourceAsStream("encoded-widget-configuration.txt")) {
			String config = IOUtils.toString(stream);
			WidgetConfiguration widgetConfiguration = new WidgetConfiguration(mock(Widget.class), config);
	...
	@Test
	public void getSearchResults_defaultNotPresent() {
		assertFalse(defaultTestConfig.getSearchResults().isPresent());
	}

	@Test
	public void getSearchResults_present() {
		defaultTestConfig.setSearchResults(new Object());
		assertTrue(defaultTestConfig.getSearchResults().isPresent());
	}

	@Test
	public void setSearchResults_nullAsValue() {
		defaultTestConfig.setSearchResults(null);
		assertFalse(defaultTestConfig.getSearchResults().isPresent());
	}
