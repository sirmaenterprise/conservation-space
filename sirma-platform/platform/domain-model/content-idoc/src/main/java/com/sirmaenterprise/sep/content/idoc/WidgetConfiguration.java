...
public class WidgetConfiguration {
	 ...
	 * results won't be persisted anywhere.
	 */
	private Optional<Object> searchResultsStore = Optional.empty();
	 ...
	 *
	 * @return the results from the widget search, if any. Returns {@link Optional#empty()} if there are no search
	 *         results stored for the specific widget
	 */
	public Optional<Object> getSearchResults() {
	 ...
	 * {@link SearchContentNodeHandler}. Accepts <code>null</code> as value.
	 *
	 * @param searchResults
	 *            the search results that should be stored for the widget
	 */
	public void setSearchResults(Object searchResults) {
		searchResultsStore = Optional.ofNullable(searchResults);
	}
