...
public class ResourceSynchronizationTest {
	...
	public void synchronizeUsers() {
		...
		verify(runner).runSynchronization(DmsToSeipUserSynchronizationConfig.NAME);
	...
	public void synchronizeGroups() {
		...
		verify(runner).runSynchronization(DmsToSeipGroupSynchronizationConfig.NAME);
	}
	...
	public void synchronizeGroupsMembers() {
		...
		verify(runner).runSynchronization(DmsToSeipGroupMembersSynchronizationConfig.NAME);
		verify(eventService).fire(any(EmfEvent.class));
	}
