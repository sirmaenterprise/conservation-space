...
public class DefaultLockServiceTest {
	...
	public void test_lockStatus() {
		...
		assertEquals("emf:instance", status.getLockedInstance().getIdentifier());
	...
	@Test
	public void test_lockStatus_Collection() {
		...
		LinkSourceId ref1 = buildInstanceRef("emf:instance1");
		LinkSourceId ref2 = buildInstanceRef("emf:instance2");
		LinkSourceId ref3 = buildInstanceRef("emf:instance3");
		LinkSourceId ref4 = buildInstanceRef("emf:instance4");
		...
		assertEquals("emf:instance1", lockInfo.getLockedInstance().getIdentifier());
		...
		assertTrue(lockInfo.isLocked());
		assertNotNull(lockInfo.getLockedInstance());
		assertEquals("emf:instance3", lockInfo.getLockedInstance().getIdentifier());
		...
		assertNotNull(lockInfo.getLockedInstance());
		assertEquals("emf:instance4", lockInfo.getLockedInstance().getIdentifier());
		assertFalse(lockInfo.isLockedByMe());
	}

	@Test
	public void test_lockStatus_Collection_emptyInput() {
		Map<InstanceReference, LockInfo> result = lockService.lockStatus(new ArrayList<>());
		assertEquals(Collections.emptyMap(), result);
	}

	@Test
	public void test_lockStatus_Collection_nullInput() {
	...
	@Test
	public void test_lock_notLocked() {
	...
	@Test
	public void test_lock_lockedByMy() {
	...
	public void test_lock_lockedByOther() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
	...
	@Test(expected = LockException.class)
	public void test_lock_lockedByOther_noPermissions() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:otherUser")));
	...
	@Test
	public void test_tryLock_lockedByMe() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:admin")));
	...
	@Test
	public void test_tryLock_notLocked() {
		LockInfo lockInfo = lockService.tryLock(buildInstanceRef("emf:instance"));
		assertNotNull(lockInfo);
		assertTrue(lockInfo.isLocked());
		assertEquals("emf:admin", lockInfo.getLockedBy());
	...
	@Test
	public void test_tryLock_lockedByOther() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:otherUser")));
	...
	@Test
	public void test_unlock_notLocked() {
	...
	@Test
	public void test_unlock_lockedByMe() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:admin")));
	...
	public void test_unlock_lockedByOther() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:otherUser")));
	...
	@Test(expected = UnlockException.class)
	public void test_unlock_lockedByOther_noPermissions() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:otherUser")));
		when(authorityService.isActionAllowed(any(Instance.class), anyString(), eq(null))).thenReturn(false);
		lockService.unlock(buildInstanceRef("emf:instance"));
	...
	@Test
	public void test_tryUnlock_lockedByMe() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:admin")));
	...
	@Test
	public void test_tryUnlock_lockedByOtherUser() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:otherUser")));
		when(authorityService.isAdminOrSystemUser(any(Resource.class))).thenReturn(false);
		when(authorityService.isActionAllowed(any(Instance.class), anyString(), eq(null))).thenReturn(false);
	...
	@Test
	public void test_isAllowedToModify_notLocked() {
		assertTrue(lockService.isAllowedToModify(buildInstanceRef("emf:instance")));
	}

	@Test
	public void test_isAllowedToModify_LockedByMe() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:admin")));
	...
	@Test
	public void test_isAllowedToModify_LockedByOtherUser() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:otherUser")));
	...
	@Test
	public void test_forceUnlock_lockedByOther_havePermissions() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:otherUser")));
	...
	@Test
	public void test_forceLock_lockedByOther_havePermissions() {
		when(dbDao.fetchWithNamed(eq(LockEntity.QUERY_LOCK_INFO_FOR_INSTANCE_KEY), anyList()))
				.thenReturn(buildLockEntitys(buildLocked("emf:instance", "emf:otherUser")));
