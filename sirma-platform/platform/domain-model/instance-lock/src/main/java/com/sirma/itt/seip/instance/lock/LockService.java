...
public interface LockService {
	 ...
	 */
	LockInfo forceLock(InstanceReference reference);
	 ...
	 */
	LockInfo tryLock(InstanceReference instance);
	 ...
	 */
	default boolean isAllowedToModify(InstanceReference reference) {
		LockInfo lockStatus = lockStatus(reference);
		return !lockStatus.isLocked() || lockStatus.isLockedByMe();
	}
