...
import com.sirma.itt.seip.instance.definition.validator.ELExpressionValiator;
...
public class ELExpressionValiatorTest extends EmfTest {
	...
	public void testLabelValidation() {
		...
		model.getLabels().put("en",
				"${eval(<a class=\"${get([status])}\" href=\"${link(currentInstance)}\">" + "<b>${id} ${CL([type])}"
