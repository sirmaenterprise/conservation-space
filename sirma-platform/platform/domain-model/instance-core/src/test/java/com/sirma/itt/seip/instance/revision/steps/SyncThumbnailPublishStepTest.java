...
public class SyncThumbnailPublishStepTest {
	...
	public void shouldDoNothingIfNoThumbnailIsFound() throws Exception {
		...
		verify(linkService, never()).link(any(InstanceReference.class), any(InstanceReference.class),
				eq(LinkConstants.HAS_THUMBNAIL), eq(LinkConstants.IS_THUMBNAIL_OF), anyMap());
	}
	...
	private static final PublishContext buildContext() {
