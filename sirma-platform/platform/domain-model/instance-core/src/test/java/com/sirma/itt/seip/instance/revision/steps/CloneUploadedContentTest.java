...
/**
 * Test for {@link CloneUploadedContent}
 *
 * @author BBonev
 */
public class CloneUploadedContentTest {
	@InjectMocks
	private CloneUploadedContent cloneUploadedDocument;
	@Mock
	...
	public void shouldTriggerContentCopyOnValidData() throws Exception {
		...
		verify(contentService).importContent(argThat(CustomMatcher.of((ContentImport content) -> {
			nullSafeEquals(content.getInstanceId(), "emf:instance-r1.0");
		})));
	}
