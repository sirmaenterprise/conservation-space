...
public class SemanticInstanceTypesTest {
	...
	public void fromInstance() throws Exception {
		...
		// calling the from method with instance that has a type should trigger refresh of that type
		verify(semanticDefinitionService, times(2)).getClassInstance(anyString());
	}
	...
	public void fromInstanceReference() throws Exception {
		...
		// calling the from method with instance that has a type should trigger refresh of that type
		verify(semanticDefinitionService, times(2)).getClassInstance(anyString());
		verify(typeResolver).resolve(any(Serializable.class));
	}
