 ...
 */
@Entity
@Table(name = "emf_archivedProperties")
@org.hibernate.annotations.Table(appliesTo = "emf_archivedProperties", indexes = {
		@Index(name = "idx_aprE_propertyId", columnNames = "propertyId"),
		@Index(name = "idx_aprE_propertyId_index", columnNames = { "propertyId", "listIndex" }),
		@Index(name = "idx_aprE_entityId_index", columnNames = { "bean_id", "bean_type" }) })
@NamedQueries({
