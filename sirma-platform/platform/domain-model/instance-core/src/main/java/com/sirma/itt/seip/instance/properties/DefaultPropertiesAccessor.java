...
public class DefaultPropertiesAccessor extends BasePropertyStorageAccessor {
	...
	public PrototypeDefinition getPropertyPrototype(String propertyName, Serializable value, PathElement pathElement,
		...
		if (propertyDef == null) {
			...
			if (alwaysPersistProperties.contains(propertyName) || !hasDefinition
					|| Options.SAVE_PROPERTIES_WITHOUT_DEFINITION.isEnabled()) {
				propertyDef = dictionaryService.getDefinitionByValue(propertyName, value);
			}
