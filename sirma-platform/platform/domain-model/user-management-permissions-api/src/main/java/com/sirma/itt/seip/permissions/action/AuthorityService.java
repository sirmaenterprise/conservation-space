...
public interface AuthorityService {
	...
	/**
	 * Gets the allowed action names on the given instance for the given user.
	 *
	 * @param resource
	 *            the reference resource to calculate actions
	 * @param instance
	 ...
	 * @return the allowed actions
	 */
	default Set<String> getAllowedActionNames(String resource, Instance instance, String placeholder) {
		return getAllowedActions(resource, instance, placeholder)
				.stream()
