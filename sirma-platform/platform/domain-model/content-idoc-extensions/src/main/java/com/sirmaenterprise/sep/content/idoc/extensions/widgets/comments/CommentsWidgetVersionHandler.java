...
import static com.sirmaenterprise.sep.content.idoc.extensions.widgets.comments.CommentsWidgetSearchHandler.INSTANCE_IDS_RESULT_MAP_KEY;
...
public class CommentsWidgetVersionHandler extends AbstractWidgetVersionHandler<CommentsWidget> {
	...
	protected HandlerResult processResults(CommentsWidget widget, Optional<Object> searchResults, Date versionDate) {
