...
import com.sirma.itt.seip.content.extract.ContentExtractor;
...
public class ScheduleViewContentExtraction extends SchedulerActionAdapter {
	...
	public void execute(SchedulerContext context) {
		...
		try {
			processContent((String) instanceId, contentInfo);
			processWidgets((String) instanceId, contentInfo);
		} finally {
	...
	/**
	 * Execute update of "emf:viewContent" {@link ScheduleViewContentExtraction}
	 *
	 * @param targetId
	 ...
	 */
	private void processContent(String targetId, ContentInfo contentInfo) {
		contentPersister.get().savePrimaryView(targetId, extractContent(contentInfo));
	}
	...
	/**
	 * Execute update of "emf:viewWidgetsContent" {@link ScheduleViewContentExtraction}
	 *
	 * @param targetId
	 * 		id of instance to be updated.
	 * @param contentInfo
	 * 		the content info of instance.
	 */
	private void processWidgets(String targetId, ContentInfo contentInfo) {
		contentPersister.get().saveWidgetsContent(targetId, extractWidgtsContent(targetId, contentInfo));
	}
