...
import com.sirmaenterprise.sep.content.idoc.extensions.widgets.recentactivities.RecentActivitiesWidgetSearchHandlerTest;
...
public class CommentsWidgetSearchHandlerTest {
	...
	public void setup() {
		...
		ReflectionUtils.setField(handler, "jsonToConditionConverter", conditionConverter);
	}
