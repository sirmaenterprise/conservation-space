...
public interface RevisionService {
	...
	/**
	 * Gets the latest published revision for the given instance.
	 *
	 * @param instance
	 *            the instance to get the latest published revision
	 * @return the latest published revision
	 */
	Instance getLatestPublishedRevision(Instance instance);
	...
	/**
	 * Gets the or create latest revision instance.
	 *
	 * @param instanceToPublish
	 *            the instance to publish
	 * @param newRevision
	 *            the new revision
	 * @return the or create latest revision instance
	 */
	Instance getOrCreateLatestRevisionInstance(Instance instanceToPublish, Instance newRevision);
