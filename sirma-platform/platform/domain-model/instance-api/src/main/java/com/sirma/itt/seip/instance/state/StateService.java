...
public interface StateService {
	 ...
	 * @return the state
	 */
	<I extends Instance> String getState(PrimaryStates stateType, Class<I> target);
	 ...
	 */
	<I extends Instance> boolean isState(PrimaryStates stateType, Class<I> target, String state);
	 ...
	 */
	<I extends Instance> boolean isStateAs(Class<I> target, String state, PrimaryStates... stateType);
