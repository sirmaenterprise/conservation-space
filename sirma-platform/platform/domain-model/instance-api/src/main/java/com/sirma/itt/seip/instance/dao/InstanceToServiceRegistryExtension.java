...
public interface InstanceToServiceRegistryExtension extends SupportablePlugin {
	...
	/**
	 * Gets the definition compiler callback that loads the definitions of the instance definitions or the extension.
	 * <p>
	 * <b>NOTE:</b> The method should return <code>null</code> if the instance does not support definition.
	 *
	 * @param <T>
	 *            the definition type
