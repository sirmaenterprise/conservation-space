...
public interface InstanceSaveStep extends Plugin, Named {
	 ...
	 *            different steps
	 * @param cause
	 *            the error that caused the save failure
	 */
	default void rollbackBeforeSave(InstanceSaveContext saveContext, Throwable cause) {
		// nothing to do here
	}
	 ...
	 *            the error that caused the save failure
	 */
	default void rollbackAfterSave(InstanceSaveContext saveContext, Throwable cause) {
		// nothing to do here
	}
