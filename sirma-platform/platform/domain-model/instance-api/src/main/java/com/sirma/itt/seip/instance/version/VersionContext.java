...
public class VersionContext extends Context<String, Object> {
	 ...
	 *            the instance for versioning
	 * @param createdOn
	 *            date when the instance version is created. It will be used as a marker in the retrieving of the
	 *            version
	 * @return new instance of version context with initial data
	 */
	 ...
	 *            date when the instance version is created. It will be used as a marker in the retrieving of the
	 *            version
	 * @param processWidgets
	 *            flag that shows if the widgets should be processed when the version view content is created.
	 *            {@link Boolean#TRUE} if they should, {@link Boolean#FALSE} if they should not
	 ...
	 *             when the passed instance is null
	 */
	 ...
	 *
	 * @param mode
	 *            the version mode with which the instance is saved. Used to control instance version incrementing
	 ...
	 *
	 * @param shouldProcess
	 *            <code>true</code> if the widgets should be processed, <code>false</code> otherwise
	 * @return current context object to allow methods chaining
	 */
