...
public class LinkConstants {
	...
	public static final String TREE_PARENT_TO_CHILD = "emf:parentOf";
	/** Relation used to define tree child to parent link. */
	public static final String TREE_CHILD_TO_PARENT = "emf:hasParent";

	public static final String PART_OF_URI = "ptop:partOf";

	public static final String REFERENCES_URI = "emf:references";

	/** The has child uri. */
	public static final String HAS_CHILD_URI = "emf:hasChild";
	...
	/** The parent to child. */
	public static final String PARENT_TO_CHILD = HAS_CHILD_URI;

	/** The child to parent. */
	public static final String CHILD_TO_PARENT = PART_OF_URI;

	/** The parent to child. */
	public static final String ROOT_TO_CHILD = HAS_CHILD_URI;

	/** The child to parent. */
	public static final String CHILD_TO_ROOT = PART_OF_URI;
	...
	/**
	 * Relation between an instance and it's primary parent. The primary parent is the instance that is the primary
	 * container for the child. This is valid only for items that are created somewhere and then can be attached to
	 * other instances.
	 */
	public static final String HAS_PRIMARY_PARENT = "emf:primaryParent";
	...
	public static final String ACTUAL_OF = "emf:actualOf";
