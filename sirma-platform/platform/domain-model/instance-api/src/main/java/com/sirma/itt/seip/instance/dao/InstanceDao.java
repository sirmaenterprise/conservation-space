...
public interface InstanceDao {
	 ...
	 */
	<E extends Instance> List<E> loadInstances(Instance owner, boolean loadProperties);
	 ...
	 */
	<P extends PropertyDefinition> Instance preSaveInstance(PropertyModel model, Collection<P> fields);
