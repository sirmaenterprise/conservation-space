...
public interface DomainInstanceService {
	 ...
	 *            Instance to save.
	 * @param operation
	 *            {@link Operation} being executed, that triggered the save
	 ...
	 *            versions. It is used when the versions of the instances are loaded.
	 * @return the saved instance
	 */
	Instance save(Instance instance, Operation operation, Date versionCreatedOn);
	 ...
	 */
	Collection<Instance> loadInstances(Collection<String> identifiers);
