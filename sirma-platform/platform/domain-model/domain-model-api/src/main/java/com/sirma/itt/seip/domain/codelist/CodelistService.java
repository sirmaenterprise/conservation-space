...
public interface CodelistService {
	...
	/**
	 * Gets the code value that matches the given {@link PropertyDefinition#getCodelist()} and value for
	 * {@link PropertyDefinition#getDefaultValue()}.
	 *
	 * @param definition
	 *            the definition
	 * @return the code value
	 */
	default CodeValue getCodeValue(PropertyDefinition definition) {
		return getCodeValue(definition.getCodelist(), definition.getDefaultValue());
	}
