...
public class SearchArguments<E> {
	...
	/**
	 * Remove latest revisions from search result
	 */
	private boolean filterOutLatestRevisions = true;
	...
	/**
	 * Getter method for filterOutLatestRevisions.
	 *
	 * @return the filterOutLatestRevisions
	 */
	public boolean isFilterOutLatestRevisions() {
		return filterOutLatestRevisions;
	}

	/**
	 * Setter method for filterOutLatestRevisions.
	 *
	 * @param filterOutLatestRevisions
	 *            the filterOutLatestRevisions to set
	 */
	public void setFilterOutLatestRevisions(boolean filterOutLatestRevisions) {
		this.filterOutLatestRevisions = filterOutLatestRevisions;
	}
