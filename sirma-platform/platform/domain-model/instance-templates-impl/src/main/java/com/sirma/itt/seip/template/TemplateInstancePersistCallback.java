...
/**
 * {@link TemplateEntity} persist callback and instance loader producer.
 */
@Singleton
class TemplateInstancePersistCallback extends BaseRelationalPersistCallback {
	 ...
	 */
	@Inject
	public TemplateInstancePersistCallback(DbDao dbDao, PropertiesService propertiesService,
	...
	private static class TemplateSecondaryIdLoadCallback extends BaseSecondaryIdEntityLoadCallback {
		...
		/**
		 * Initialize new {@link TemplateSecondaryIdLoadCallback}.
		 *
		 * @param dbDao
		 *            the dao that will be used to load templates
		 */
