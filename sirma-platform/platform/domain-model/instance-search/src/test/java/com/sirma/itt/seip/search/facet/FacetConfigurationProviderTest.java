...
public class FacetConfigurationProviderTest {
	...
	/**
	 * Initializes {@link #facetConfigurationProvider} and injects any Mockito mocks.
	 */
	@BeforeMethod
	public void setUp() {
	...
	public void testWithoutConfigurationField() {
		...
		Mockito.when(dictionaryService.getAllDefinitions(GenericDefinition.class)).thenReturn(genericDefinitions);
	 ...
	 */
	private GenericDefinition mockGenericDefinition(String definitionType, String definitionId) {
