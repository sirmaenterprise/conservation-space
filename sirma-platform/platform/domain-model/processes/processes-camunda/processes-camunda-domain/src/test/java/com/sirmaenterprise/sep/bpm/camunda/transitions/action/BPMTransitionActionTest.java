...
public class BPMTransitionActionTest {
	...
	public void testPerformInvalidRequest() throws Exception {
		BPMTransitionRequest request = new BPMTransitionRequest();
		bPMTransitionAction.perform(request);
	}

	@Test
	public void testPerformWithMissingTransition() throws Exception {
	...
	@Test
	public void testPerformSingleInstance() throws Exception {
		BPMTransitionRequest request = buildWorkingRequest();
	...
	@Test
	public void testPerformSingleInstance_nullTrasition() throws Exception {
		...
		when(instanceRef.getIdentifier()).thenReturn(targetId);
	...
	@Test
	public void testPerformSingleInstance_CompletedInstance() throws Exception {
		String targetId = "emf:targetId";
		BPMTransitionRequest request = new BPMTransitionRequest();
		request.setTargetId(targetId);
		request.setTransitionData(new HashMap<>());
	...
	public void testAddActivitiesValid() throws Exception {
		...
		when(instance.getString(eq(ProcessConstants.ACTIVITY_ID))).thenReturn("taskId");
		ThreadLocal<Collection> generated = (ThreadLocal<Collection>) ReflectionUtils.getField(bPMTransitionAction,
				"processedActivities");
	...
	@Test
	public void testListGeneratedActivities() {
		BPMTransitionRequest request = new BPMTransitionRequest();
		when(camundaBPMNService.listActiveTasksIds("emf:process")).thenReturn(Arrays.asList("activity1"));
		ThreadLocal<Collection> generated = (ThreadLocal<Collection>) ReflectionUtils.getField(bPMTransitionAction,"processedActivities");
