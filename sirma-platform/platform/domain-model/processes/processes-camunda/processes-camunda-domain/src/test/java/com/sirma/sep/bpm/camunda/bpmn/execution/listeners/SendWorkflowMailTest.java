...
public class SendWorkflowMailTest {
	...
	public void testExecute() throws Exception {
		...
		when(schedularService.buildEmptyConfiguration(any())).thenReturn(schedulerConfiguration);
		...
		Mockito.verify(schedularService).schedule(eq(BPMMailScheduler.BEAN_ID), eq(schedulerConfiguration), any());
	}
