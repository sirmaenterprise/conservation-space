...
public class CollectMultiInstanceUsersTest {
	...
	public void testNotifyInvalidSource() throws Exception {
		ReflectionUtils.setField(collectMultiInstanceUsers, "source", null);
		ReflectionUtils.setField(collectMultiInstanceUsers, "target", mock(FixedValue.class));
		collectMultiInstanceUsers.validateParameters();
	}

	@Test(expected = NullPointerException.class)
	public void testNotifyInvalidTarget() throws Exception {
		ReflectionUtils.setField(collectMultiInstanceUsers, "source", mock(Expression.class));
		ReflectionUtils.setField(collectMultiInstanceUsers, "target", null);
		collectMultiInstanceUsers.validateParameters();
	}
	...
	public void testNotify() throws Exception {
		...
		ReflectionUtils.setField(collectMultiInstanceUsers, "source", source);
		ReflectionUtils.setField(collectMultiInstanceUsers, "target", target);
