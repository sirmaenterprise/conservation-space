...
public class BPMRoleActionEvaluator extends DomainObjectsBaseRoleEvaluator<ObjectInstance> {
	 ...
	 * Claim BPM Action
	 */
	protected static final Action CLAIM = new EmfAction(AllowedActionType.TASK_CLAIM.getType());
	/**
	 * Release BPM Action
	 */
	protected static final Action RELEASE = new EmfAction(AllowedActionType.TASK_RELEASE.getType());
