...
public class CamundaIntegrationTest {
	...
	public void setUp() throws Exception {
		...
		modelConverter = Mockito.mock(BPMPropertiesConverter.class);
		ReflectionUtils.setField(processService, "processEngine", processEngine);
		ReflectionUtils.setField(processService, "modelConverter", modelConverter);
	}
