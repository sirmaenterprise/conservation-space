...
import static com.sirma.itt.seip.content.Content.PRIMARY_VIEW;
...
import com.sirma.itt.seip.content.rest.ContentDownloadService;
...
public class InstanceContentDownloadRestService {
	...
	public void streamPreview(@PathParam(KEY_ID) String instanceId, @QueryParam(PURPOSE) String purpose,
		...
		downloadService.sendPreview(instanceId, defaultIfBlank(purpose, PRIMARY_CONTENT), response);
	}
}