 ...
 */
public class SepXHTMLImageHandlerTest {
	...
	public static void addFailureMessageTest() {
		...
		SepXHTMLImageHandler.addFailureMessage(paragraph, TEST_MESSAGE);
	...
	public static void loadImageByURLFromHDDTest() {
		...
		byte[] loadImageByURL = SepXHTMLImageHandler.loadImageByURL(docx4jUserAgent, "D:\test.jpg");
	...
	public void loadImageByURLTest() {
		...
		byte[] imageBytes = SepXHTMLImageHandler.loadImageByURL(docx4jUserAgent, testJpgURL.toString());
	...
	public void createImagePartTest() throws InvalidFormatException, JAXBException, PartUnrecognisedException, IOException {
		...
		BinaryPartAbstractImage createImagePart = SepXHTMLImageHandler.createImagePart(imageBytes, wordMLPackage);
	...
	public static void createImagePartEmptyImageContentTest() throws InvalidFormatException, JAXBException, PartUnrecognisedException, IOException {
		...
		wordMLPackage.getMainDocumentPart().addTargetPart(ndp);
		ndp.unmarshalDefaultNumbering();
		BinaryPartAbstractImage createImagePart = SepXHTMLImageHandler.createImagePart(new byte[0], wordMLPackage);
	...
	public void addImageWithNoneScaleTest() throws InvalidFormatException, JAXBException {
		...
		URL testJpgURL = getClass().getClassLoader().getResource("test.jpg");
		Mockito.when(e.getAttribute(SepXHTMLImageHandler.SRC)).thenReturn(testJpgURL.toString());
		Docx4jUserAgent docx4jUserAgent = new Docx4jUserAgent();
		WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage.createPackage();
		NumberingDefinitionsPart ndp = new NumberingDefinitionsPart();
		wordMLPackage.getMainDocumentPart().addTargetPart(ndp);
		ndp.unmarshalDefaultNumbering();
		SepXHTMLImageHandler sepXHTMLImageHandler = new SepXHTMLImageHandler(null, content -> new byte[0]);
	...
	public void addImageWithBase64Test() throws InvalidFormatException, JAXBException, IOException {
		...
		try (InputStream testJpgURLInputStream = getClass().getClassLoader().getResourceAsStream("test.jpg")) {
			...
			Mockito.when(e.getAttribute(SepXHTMLImageHandler.SRC)).thenReturn(base64);
			Docx4jUserAgent docx4jUserAgent = new Docx4jUserAgent();
			WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage.createPackage();
			NumberingDefinitionsPart ndp = new NumberingDefinitionsPart();
			wordMLPackage.getMainDocumentPart().addTargetPart(ndp);
	...
	public void addEmbeddedImage() throws InvalidFormatException, JAXBException {
		...
		Element e = Mockito.mock(Element.class);
		URL testJpgURL = getClass().getClassLoader().getResource("test.jpg");
		Mockito.when(e.hasAttribute(SepXHTMLImageHandler.EMBEDDED_ID)).thenReturn(Boolean.TRUE);
		Mockito.when(e.getAttribute(SepXHTMLImageHandler.EMBEDDED_ID)).thenReturn("emf:embeddedImageId");
		Mockito.when(e.getAttribute(SepXHTMLImageHandler.SRC)).thenReturn("");
		Docx4jUserAgent docx4jUserAgent = new Docx4jUserAgent();
		WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage.createPackage();
		NumberingDefinitionsPart ndp = new NumberingDefinitionsPart();
		wordMLPackage.getMainDocumentPart().addTargetPart(ndp);
		ndp.unmarshalDefaultNumbering();
		SepXHTMLImageHandler sepXHTMLImageHandler = new SepXHTMLImageHandler(null, content -> {
	...
	public static void getTblCellMarginsNullStyleTest() {
		...
		SepXHTMLImageHandler sepXHTMLImageHandler = new SepXHTMLImageHandler(importer, content -> new byte[0]);
		sepXHTMLImageHandler.setMaxWidth(300, null);
