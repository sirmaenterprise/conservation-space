...
public class AnnotationWriter {
	 ...
	 * {@link Annotation#getResponseProperties()}. Property names are converted to short URI format if not and values
	...
	private Serializable convertValue(Serializable value) {
		...
		if (value instanceof Collection<?>) {
			...
			result = namespaceRegistryService.getShortUri((URI) value);
