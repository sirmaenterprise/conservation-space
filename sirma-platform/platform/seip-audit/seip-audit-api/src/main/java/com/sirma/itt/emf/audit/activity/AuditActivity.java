...
@org.hibernate.annotations.Table(appliesTo = "emf_events", indexes = {
		@Index(name = "idx_datereceived", columnNames = "datereceived") })
...
public class AuditActivity implements Serializable, com.sirma.itt.seip.Entity<Long> {
	...
	static final String GET_ACTIVITIES_AFTER = "select distinct aa from AuditActivity aa where aa.requestId in ("
