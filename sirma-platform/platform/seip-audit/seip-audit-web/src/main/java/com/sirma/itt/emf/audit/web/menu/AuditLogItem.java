...
public class AuditLogItem extends MainMenu {
	...
	public static class AuditLogNavigationFragment extends AbstractPageModel implements PageFragment {

		private static final String FRAGMENT_NAME = "audit-log";

		private static final String AUDIT_LOG_TEMPLATE_PATH = "header/mainmenu/" + AdminMenuExtension.FRAGMENT_NAME
				+ "/" + FRAGMENT_NAME;
		...
		public String getPageFragment() {
			return buildTemplate(
					createModel(FRAGMENT_NAME, "/audit/audit-log.jsf", "emf.bam.auditlog", null, null, null),
					AUDIT_LOG_TEMPLATE_PATH);
		}
	}
}
