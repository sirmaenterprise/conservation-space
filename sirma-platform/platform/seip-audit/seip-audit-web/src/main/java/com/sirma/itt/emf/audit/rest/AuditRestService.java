...
public class AuditRestService extends EmfRestService {
	...
	public Response getEvents(@QueryParam("query") String query, @QueryParam("fq") String[] filterQueries,
	...
	@GET
	@Path("/export")
	public Response export(@QueryParam("query") String query, @QueryParam("fq") String[] filterQueries,
	 ...
	 */
	private SolrQuery buildParams(String query, String[] filterQueries, int start, int rows, String sortField,
			String sortOrder) {
