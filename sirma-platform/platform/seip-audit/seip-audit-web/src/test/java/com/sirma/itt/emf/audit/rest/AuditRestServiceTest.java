...
public class AuditRestServiceTest {
	...
	/**
	 * Tests {@link AuditRestService#getEvents(String, String[], int, int, String, String)} with correct parameters and
	 * mock.
	 */
	@Test
	public void testGetEvents() {
		Capture<SolrQuery> serviceMock = setupAuditServiceMock(false);
		Response response = auditRestService.getEvents("zee query", new String[] { "1", "2", "3" }, 1, 2, "", "");
	...
	public void testGetEventsWithoutSort() {
		Capture<SolrQuery> serviceMock = setupAuditServiceMock(false);
		auditRestService.getEvents("", new String[] {}, 1, 2, "", "");
		SolrQuery solrQuery = serviceMock.getValue();
		Assert.assertEquals(0, solrQuery.getSorts().size());

		serviceMock = setupAuditServiceMock(false);
		auditRestService.getEvents("", new String[] {}, 1, 2, null, null);
		solrQuery = serviceMock.getValue();
		Assert.assertEquals(0, solrQuery.getSorts().size());

		serviceMock = setupAuditServiceMock(false);
		auditRestService.getEvents("", new String[] {}, 1, 2, null, "asc");
		solrQuery = serviceMock.getValue();
		Assert.assertEquals(0, solrQuery.getSorts().size());

		serviceMock = setupAuditServiceMock(false);
		auditRestService.getEvents("", new String[] {}, 1, 2, "field", null);
		solrQuery = serviceMock.getValue();
		Assert.assertEquals(0, solrQuery.getSorts().size());

		serviceMock = setupAuditServiceMock(false);
		auditRestService.getEvents("", new String[] {}, 1, 2, "field", "");
		solrQuery = serviceMock.getValue();
		Assert.assertEquals(0, solrQuery.getSorts().size());

		serviceMock = setupAuditServiceMock(false);
		auditRestService.getEvents("1", new String[] {}, 1, 2, "field", "blaaa");
		solrQuery = serviceMock.getValue();
		Assert.assertEquals(0, solrQuery.getSorts().size());
	...
	/**
	 * Tests {@link AuditRestService#getEvents(String, String[], int, int, String, String)} with correct parameters but
	 * with sorting.
	 */
	@Test
	public void testGetEventsWithSort() {
		Capture<SolrQuery> serviceMock = setupAuditServiceMock(false);
		auditRestService.getEvents("", new String[] {}, 1, 2, "this is my ASC field", "aSc");
		SolrQuery solrQuery = serviceMock.getValue();
		...
		serviceMock = setupAuditServiceMock(false);
		auditRestService.getEvents("", new String[] {}, 1, 2, "THIS is My DESC field", "dEsC");
		solrQuery = serviceMock.getValue();
		Assert.assertEquals(1, solrQuery.getSorts().size());
	...
	/**
	 * Tests {@link AuditRestService#getEvents(String, String[], int, int, String, String)} with exception thrown by
	 * {@link AuditService}
	 */
	@Test
	public void testGetEventsWithException() {
		setupAuditServiceMock(true);
		Response response = auditRestService.getEvents("", new String[] {}, 1, 2, "", "");
	...
	/**
	 * Tests {@link AuditRestService#export(String, String[], String, String, String, String)} without any specified
	 * file format.
	 */
	@Test
	public void testExportWithoutFormat() {
		Response response = auditRestService.export("", new String[] {}, "", "", "", "");
		Assert.assertEquals(400, response.getStatus());
	}

	/**
	 * Tests {@link AuditRestService#export(String, String[], String, String, String, String)} with 'CSV' for file
	 * format.
	 */
	@Test
	public void testExportAsCSV() {
		...
		Response response = auditRestService.export("", new String[] {}, "", "", "csV", "[]");
	...
	/**
	 * Tests {@link AuditRestService#export(String, String[], String, String, String, String)} with 'PDF' for file
	 * format.
	 */
	@Test
	public void testExportAsPdf() {
		...
		Response response = auditRestService.export("", new String[] {}, "", "", "pDf", "[]");
	...
	/**
	 * Tests {@link AuditRestService#export(String, String[], String, String, String, String)} with exceptions thrown by
	...
	public void testExportWithException() {
		...
		setupAuditServiceMock(true);
		setupExportServiceMock("pdf", null);
		response = auditRestService.export("", new String[] {}, "", "", "pdf", "[]");
		Assert.assertEquals(500, response.getStatus());
