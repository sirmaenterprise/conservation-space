...
/**
 * Abstract component that can be used to decorate other components behavior. The implementer should provide
 * implementation for at least {@link #start()} method.
 *
 * @author BBonev
 */
public abstract class AbstractDecoratingComponent implements Component {
	 ...
	 *            the decorated
	 */
	public AbstractDecoratingComponent(Component decorated) {
	 ...
	 */
	protected Component getDecorated() {
		return decorated;
	}
