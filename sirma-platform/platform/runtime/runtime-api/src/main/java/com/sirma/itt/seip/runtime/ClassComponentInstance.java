...
import com.sirma.itt.seip.runtime.AbstractComponentInstance;
 ...
 * @author BBonev
 */
public class ClassComponentInstance extends AbstractComponentInstance {
	 ...
	 *            the bean manager
	 */
	public ClassComponentInstance(Startup annotation, Class<?> actualClass, BeanManager beanManager) {
