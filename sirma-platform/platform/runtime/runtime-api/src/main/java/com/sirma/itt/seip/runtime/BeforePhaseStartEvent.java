 ...
 * returned from {@link #getComponents()} and add via the method {@link #addComponent(Component)}. Note that cannot add
...
public class BeforePhaseStartEvent {
	 ...
	 *            the components
	 */
	public BeforePhaseStartEvent(StartupPhase phase, Collection<Component> components) {
		this.phase = phase;
