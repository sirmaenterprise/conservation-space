...
public class Options {
	...
	public static final Option DISABLE_AUTOMATIC_PARENT_CHILD_LINKS = RuntimeContext
			.createOption(RuntimeConfigurationProperties.DISABLE_AUTOMATIC_PARENT_CHILD_LINKS);
	...
	public static final Option DISABLE_AUTOMATIC_LINKS = RuntimeContext.createGroup(
			...
			DISABLE_AUTOMATIC_PARENT_CHILD_LINKS);
