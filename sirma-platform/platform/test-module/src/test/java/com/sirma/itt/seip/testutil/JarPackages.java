...
public enum JarPackages implements TestableJarModules {
	...
	BASIC() {
		...
		public JavaArchive add(TestPackageBuilder builder, JavaArchive archive) {
			return archive
					.addClasses(builder.buildCacheClasses())
						.addClasses(builder.buildDefinitions())
						.addClasses(builder.buildConverters())
						...
						.addClasses(builder.buildConfigClasses())
						.addClasses(builder.buildDaoClasses())
	...
	/*
	 * (non-Javadoc)
	 * @see com.sirma.itt.cmf.testutil.TestableJarModules#add(com.sirma.itt.cmf .testutil. TestResourceBuilder,
