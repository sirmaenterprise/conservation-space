...
/**
 * The TestableJarModules is interface to represent extension the the testable jar archive, attached by the method
 * {@link #add(TestResourceBuilder, JavaArchive)}.
 */
