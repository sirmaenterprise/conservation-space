...
/**
 * The TestResouceBuilderWrapper is helper classes for dynamic build of war file. Invoke the {@link #packageWar()} to
 * produce the default war
 */
public class TestResouceBuilderWrapper {
	...
	public TestResouceBuilderWrapper init() {
		return init(JarPackages.BASIC, JarPackages.DOZER, JarPackages.SECURITY, JarPackages.CASE_CREATION,
				JarPackages.ADAPTERS_MOCK, JarPackages.RESOURCES);
	}
