...
public interface InstanceHeaderBuilder {
	 ...
	 * @param size
	 *            tree header size
	 * @return icon size as string {@link TreeHeaderBuilder}, but we need to access or calculate icon size in the view.
	 */
	 ...
	 */
	String getCompactHeaderStyleClass(Instance instance, String size, boolean isFirst, boolean isLast);
