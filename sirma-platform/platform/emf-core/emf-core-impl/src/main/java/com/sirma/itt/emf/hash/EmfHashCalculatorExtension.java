...
public class EmfHashCalculatorExtension implements HashCalculatorExtension {
	...
	private static final List<Class> SUPPORTED_OBJECTS = new ArrayList<>(Arrays.asList(ControlDefinitionImpl.class,
			...
			TransitionDefinitionImpl.class, RegionDefinitionImpl.class, AllowedChildDefinitionImpl.class,
			AllowedChildConfigurationImpl.class, StateTransitionImpl.class, Instance.class, ControlParamImpl.class));
	...
	public Integer computeHash(HashCalculator calculator, Object object) {
		if (object instanceof Instance) {
			...
			return computeHashCode((AllowedChildConfiguration) object, calculator);
			...
			return computeHashCode((ControlParam) object, calculator);
		}
		return null;
	}
	 ...
	 * @return the int
	 */
	protected int computeHashCode(ControlParam definition, HashCalculator calculator) {
		int result = 1;
