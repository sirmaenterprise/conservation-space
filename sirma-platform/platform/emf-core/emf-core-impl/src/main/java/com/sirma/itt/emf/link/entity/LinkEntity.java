...
public class LinkEntity extends BaseStringIdEntity implements Identity, PathElement {
	...
	@AttributeOverrides(value = {
			@AttributeOverride(name = "sourceId", column = @Column(name = "fromId", length = 50, nullable = false) ) })
	private LinkSourceId from;

	/** The to. */
	@AttributeOverrides(value = {
			@AttributeOverride(name = "sourceId", column = @Column(name = "toId", length = 50, nullable = false) ) })
