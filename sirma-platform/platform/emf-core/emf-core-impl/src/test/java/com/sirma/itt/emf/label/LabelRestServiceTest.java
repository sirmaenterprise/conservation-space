...
public class LabelRestServiceTest extends EmfTest {
	...
	protected void initTests() {
		...
		ReflectionUtils.setField(labelsRestService, "fieldValueRetrievalService", fieldValueRetrievalService);
		ReflectionUtils.setField(labelsRestService, "typeConverter", typeConverter);
		ReflectionUtils.setField(labelsRestService, "labelProvider", labelProvider);
	}
	...
	public void testGetBundleLabels() {
		...
		Assert.assertEquals("{\"id1\":\"label\",\"id2\":\"label\"}", result);
	}

	/**
	 * Tests the {@link com.sirma.cmf.web.rest.LabelsRestService#getLabels(java.util.List)} when retrieving label by
	...
	/**
	 * Tests the {@link com.sirma.cmf.web.rest.LabelsRestService#getLabels(java.util.List)} when retrieving user display
	 * names by URI.
	 */
