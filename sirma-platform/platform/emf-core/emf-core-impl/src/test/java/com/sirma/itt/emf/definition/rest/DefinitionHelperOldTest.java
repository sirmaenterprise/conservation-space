...
public class DefinitionHelperOldTest {
	...
	public void toJsonModel_throws_exception_when_missing_arguments() {
		definitionHelper.toJsonModel(null, null, null, null, false);
	}
	...
	private PropertyDefinition buildFieldDefinition(String identifier, String type, String datatype,
	...
	private Set<String> buildMandatoryFieldIdsList() {
	...
	private FieldDefinitionImpl createField(String id, int order, boolean isMandatory) {
	...
	private BaseRegionDefinition<BaseRegionDefinition<?>> buildDefinitionModel() {
		BaseRegionDefinition<BaseRegionDefinition<?>> definitionModel = new BaseRegionDefinition<>();
		List<PropertyDefinition> fields = new LinkedList<>();
		definitionModel.setFields(fields);
