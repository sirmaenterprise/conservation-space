...
Ext.onReady(function() {
    ...
    if (Ext.Date) {
        Ext.Date.monthNames = [_emfLabels['emf.calendar.monthname.jan'], _emfLabels['emf.calendar.monthname.feb'],
                               _emfLabels['emf.calendar.monthname.mar'], _emfLabels['emf.calendar.monthname.apr'], _emfLabels['emf.calendar.monthname.may'],
                               _emfLabels['emf.calendar.monthname.jun'], _emfLabels['emf.calendar.monthname.jul'], _emfLabels['emf.calendar.monthname.aug'],
                               _emfLabels['emf.calendar.monthname.sep'], _emfLabels['emf.calendar.monthname.oct'],
                               _emfLabels['emf.calendar.monthname.nov'], _emfLabels['emf.calendar.monthname.dic']];
        ...
        Ext.Date.dayNames = [_emfLabels['emf.calendar.dayname.sun'], _emfLabels['emf.calendar.dayname.mon'],
                             _emfLabels['emf.calendar.dayname.tue'], _emfLabels['emf.calendar.dayname.wed'],
                             _emfLabels['emf.calendar.dayname.thu'], _emfLabels['emf.calendar.dayname.fri'],
                             _emfLabels['emf.calendar.dayname.sat']];
  ...
  //This is needed until we can refactor all of the locales into individual files
    ...
    Ext.define("Ext.locale.en.grid.header.Container", {
        ...
        sortAscText: _emfLabels['emf.context.sortascending'],
        sortDescText: _emfLabels['emf.context.sortdescending'],
        columnsText: _emfLabels['emf.context.columns']
    });
