...
$.fn.extjsDataGrid = function(options) {
	...
	return this.each(function() {
		...
		//attach the bottom bar to the grid, if it is provided
		var bottomBar = null;
		if(options.bbarConfig) {
			options.bbarConfig.store = store;
			bottomBar = Ext.create('Ext.PagingToolbar', options.bbarConfig);
		}
