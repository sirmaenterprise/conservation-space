...
/**
 * The listener interface for receiving emfServletContext events. The class that is interested in processing a
 * emfServletContext event implements this interface, and the object created with that class is registered with a
 * component using the component's <code>addEmfServletContextListener</code> method. When the emfServletContext event
