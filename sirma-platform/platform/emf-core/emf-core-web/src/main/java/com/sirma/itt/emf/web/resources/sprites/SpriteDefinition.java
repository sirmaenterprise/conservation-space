...
public interface SpriteDefinition extends PathDefinition {
	...
	/**
	 * Path definition in this extension point should point to a directory within the application context or a directory
	 * inside a jar file located in *.jar/META-INF/resources. The path specified here should begin with /.
	 */
