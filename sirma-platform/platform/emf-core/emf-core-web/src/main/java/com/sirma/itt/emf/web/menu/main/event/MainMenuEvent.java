...
import com.sirma.itt.seip.domain.event.AbstractContextEvent;

/**
 * MainMenuEvent is fired when user selects any item in the main menu. This event carries the navigation string and can
 * hold some additional data stored in underlying context.
 *
 * @author svelikov
 */
