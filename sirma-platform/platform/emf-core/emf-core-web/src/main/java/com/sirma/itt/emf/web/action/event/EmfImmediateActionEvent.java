...
/**
 * The event is fired when executing an immediate action event started from the automatically generated operations
 * through the user interface. If the event is handled and nothing more is needed to be performed then the property
 * handled provided via {@link HandledEvent} should be set to <code>true</code>. Otherwise the event will trigger the
 * default functionality to save the payload instance. If the method {@link #isHandled()} returns <code>true</code> then
