...
/**
 * UI extension point for application header region below navigation menu. This header is used to render application
 * title if just CMF module is deployed or any other content that may be provided as extension.
 *
 * @author svelikov
 */
@Named
