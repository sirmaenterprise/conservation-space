...
public interface SynchronizationDataProvider<I, E> extends SynchronizationProvider<Collection<? extends E>> {
	 ...
	 */
	static <I, E> SynchronizationDataProvider<I, E> create(SynchronizationProvider<Collection<? extends E>> provider,
	...
	class SynchronizationCallback<A, T> implements SynchronizationDataProvider<A, T> {
		...
		private final SynchronizationProvider<Collection<? extends T>> provider;
		 ...
		 */
		public SynchronizationCallback(SynchronizationProvider<Collection<? extends T>> provider,
