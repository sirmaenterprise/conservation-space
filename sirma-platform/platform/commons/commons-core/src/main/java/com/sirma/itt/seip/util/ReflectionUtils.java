...
public class ReflectionUtils {
	 ...
	 * @param generic
	 *            Parameterized type.
	 * @return {@code null} if the provided type is not an instance of
	 *         {@link ParameterizedType}, otherwise returns the first element of
	...
	/**
	 * Checks if the first type argument is assignable from the provided type.
	 * This method uses {@link ReflectionUtils#getTypeArgument(Type)} to extract
	 ...
	 * @return {@code true} if the provided type is assignable from the target
	 *         class.
	 */
