...
public class UriConverterProvider implements TypeConverterProvider {
	...
	public void register(TypeConverter converter) {
		...
		converter.addConverter(String.class, StringUriProxy.class, new StringToUriConverter<StringUriProxy>());
		converter.addConverter(StringUriProxy.class, String.class, source -> source.toString());
	 ...
	 *            the generic type
	 */
	public static class StringToUriConverter<R extends Uri> implements Converter<String, R> {
