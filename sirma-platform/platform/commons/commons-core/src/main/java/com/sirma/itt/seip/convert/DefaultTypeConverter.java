...
public class DefaultTypeConverter implements TypeConverterProvider {
	 ...
	 *            the list type type
	 */
	private static final class ListToStringConverter<L extends List> implements Converter<L, String> {
	...
	public void register(TypeConverter converter) {
		...
		converter.addConverter(String.class, Boolean.class, source -> Boolean.valueOf(source));
		...
		converter.addConverter(BigDecimal.class, String.class, source -> source.toString());
		...
		converter.addConverter(ArrayList.class, String.class, new ListToStringConverter<>(converter));
		converter.addConverter(LinkedList.class, String.class, new ListToStringConverter<>(converter));
		converter.addConverter(AbstractList.class, String.class, new ListToStringConverter<>(converter));
