...
class ConfigurationEntity implements Entity<ConfigurationId>, Serializable {
	...
	/**
	 * Query {@link ConfigurationEntity#getValue()} by configuration id and tenant id. Params: id and tenantId
	 */
	...
	/**
	 * Query {@link ConfigurationEntity}s for a single tenant. The query will return all system properties and the one
	 * specific for the tenant. Params: systemTenant, tenantId
	 */
