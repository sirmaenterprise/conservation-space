package com.sirma.itt.cmf.hash;
...
import com.sirma.itt.cmf.script.BaseScriptDefinitionTest;
import com.sirma.itt.cmf.util.CmfHashCalculatorExtension;
...
public class HashCalculatorImplTest extends BaseScriptDefinitionTest {
	...
	public void beforeMethod() {
		...
		list.add(new CmfHashCalculatorExtension());
