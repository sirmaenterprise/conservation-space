...
/**
 * Entity that will hold information about tasks assigned to user from each workflow and for particular instance
 *
 * @author BBonev
 */
@Entity
...
@org.hibernate.annotations.Table(appliesTo = "cmf_assignedUserTasks", indexes = {
		@Index(name = "idx_aut_user_ref_nu_a", columnNames = { "userid", "owninginstanceid", "owninginstancetype",
				"active" }),
		@Index(name = "idx_aut_contextid", columnNames = { "contextreferenceid", "contextreferencetype" }),
...
public class AssignedUserTasks extends BaseEntity {
	...
	private String taskDmsId;
	/** The context reference. */
	@AttributeOverrides(value = {
			@AttributeOverride(name = "sourceId", column = @Column(name = "contextreferenceid", length = 50, nullable = true) ) })
	 ...
	 */
	public void setTaskDmsId(String taskInstanceId) {
		taskDmsId = taskInstanceId;
	}
	...
	public String toString() {
		...
		builder
				.append("AssignedUserTasks [taskType=")
					.append(taskType)
					.append(", userId=")
					.append(userId)
					.append(", poolUsers=")
