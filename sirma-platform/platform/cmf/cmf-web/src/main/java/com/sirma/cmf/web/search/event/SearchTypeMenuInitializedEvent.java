...
/**
 * SearchTypeMenuInitializedEvent fired when the search page is selected trough the application menu. Allows the
 * dropdown menu to be initialized with different values or to be filtered.
 *
 * @author svelikov
 */
