...
public abstract class AbstractBrowserHandler<E extends Entity, T extends Entity, A extends Entity>
	...
	/**
	 * When iterated result list, this method is invoked to check if current iteration element is same as selected in
	 * order to apply some css class for styling.
	 *
	 * @param e
	 *            the e
	...
	/**
	 * After search is invoked by the entity browser api after searching in order to allow results list to be modified.
	 *
	 * @param <S>
