...
public class DateRangeFieldBuilder extends ControlBuilder {
	 ...
	 *            the date util
	 */
	public DateRangeFieldBuilder(LabelProvider labelProvider, CodelistService codelistService, DateUtil dateUtil) {
	...
	public void build() {
		...
		if (displayStatus) {
			...
			boolean previewStatus = isEditMode(previewStatusKey);
			...
			isFormEditMode = isEditMode(previewStatusKey);
			if (isFormEditMode) {
				...
				fieldWrapper.getChildren().addAll(buildOutputField());
			}
	...
	public UIComponent getComponentInstance() {
		HtmlInputText uiComponent = (HtmlInputText) createComponentInstance("javax.faces.HtmlInputText",
				"javax.faces.Text");
	...
	public void addAfterFieldContent(UIComponent wrapper) {
		...
		if (endDateFieldParam != null && StringUtils.isNotNullOrEmpty(endDateFieldParam.getName())) {
