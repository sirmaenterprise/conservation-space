...
/**
 * The Class SearchTypeSelectedEvent. Fired when an item is selected from the menu that holds the search types. Allows
 * some initialization work to be performed before the search arguments page to be loaded (for example - initializing
