...
public class SearchpageSelectAction extends Action implements Serializable {
	...
	/**
	 * Gets the search pages. This fires an event with the pages list to allow it to be extended in third party systems.
	 *
	 * @return the search pages
	 */
	public List<SearchPage> getSearchPages() {
		List<SearchPage> searchPages = new ArrayList<SearchPage>();
		searchPages.add(new SearchPage(SearchConstants.CASE_SEARCH,
				labelProvider.getValue(SearchConstants.SEARCHPAGE_LABEL_PREF + SearchConstants.CASE_SEARCH)));
		searchPages.add(new SearchPage(SearchConstants.TASK_SEARCH,
				labelProvider.getValue(SearchConstants.SEARCHPAGE_LABEL_PREF + SearchConstants.TASK_SEARCH)));
		searchPages.add(new SearchPage(SearchConstants.DOCUMENT_SEARCH,
				labelProvider.getValue(SearchConstants.SEARCHPAGE_LABEL_PREF + SearchConstants.DOCUMENT_SEARCH)));
	...
	/**
	 * Setter method for selectedSearchPage. An event is fired when page is selected from the menu.
	 *
