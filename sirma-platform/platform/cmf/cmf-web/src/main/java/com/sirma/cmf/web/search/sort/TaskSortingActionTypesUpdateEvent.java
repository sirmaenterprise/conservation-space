...
/**
 * Event fired after the sorting actions are requested and build in the CMF to allow clients to contribute to the
 * sorting options.
 *
 * @author svelikov
 */
public class TaskSortingActionTypesUpdateEvent implements EmfEvent {
	 ...
	 */
	public TaskSortingActionTypesUpdateEvent(List<SortActionItem> sortActionItemsList) {
		sortActionItems = sortActionItemsList;
	}
