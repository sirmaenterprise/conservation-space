...
public class MultiItemConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		if (StringUtils.isNotNullOrEmpty(styleClass) && styleClass.contains("picklist-hidden-field")) {
	...
	/**
	 * Interates over array of values and returns single string representing the user names. {@inheritDoc}
	 */
	@Override
