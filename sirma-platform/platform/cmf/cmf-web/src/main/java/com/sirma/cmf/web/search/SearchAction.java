...
/**
 * The Interface SearchAction. This is a marker interface that should be implemented from all search action classes that
 * are involved in searching in entity browser.
 *
 * @author svelikov
 */
