...
/**
 * SearchFilterUpdateEvent if fired during ui building when particular search filters list is built. The search filters
 * can be retrieved from the event object and can be modified in observer.
 *
 * @author svelikov
 */
