...
/**
 * Extension point that allows other modules to provide additional non default action types. Non default actions are
 * those that allow some custom button xhtml (see action-button-template.xhtml) and event handler implementation.
 *
 * @author svelikov
 */
public interface NonDefaultActionButtonExtensionPoint extends Plugin {
	 ...
	 */
	String EXTENSION_POINT = "non.default.action.button.extension.point";
