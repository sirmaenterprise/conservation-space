...
/**
 * This class will holds extension for browser tab. Based on modules that are loaded will switch functionality for
 * generating tab title and icon.
 *
 * @author cdimitrov
 */
public class MainBrowserTabsExtensionPoint {
	...
	/**
	 * Retrieve the path of page that will generate browser tabs icon and title based on available <b>context
	 * instance</b> and <b>URL path.</b>
	 */
