...
public class SelectorItem {
	...
	public static final Comparator<SelectorItem> ID_COMPARATOR = new SelectorComparator(SelectorField.ID);
	/** The Constant TYPE_COMPARATOR. */
	public static final Comparator<SelectorItem> TYPE_COMPARATOR = new SelectorComparator(SelectorField.TYPE);
	...
	private static class SelectorComparator implements Comparator<SelectorItem> {
		...
		/** The type. */
		private final SelectorField type;
