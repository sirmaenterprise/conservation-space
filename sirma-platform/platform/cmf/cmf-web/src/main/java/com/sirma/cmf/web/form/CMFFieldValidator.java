...
public class CMFFieldValidator implements Validator {
	...
	/**
	 * Validates a jsf control against field information. If the validation fails, ValidatorException with error message
	 * is thrown.
	 *
	 * @param context
	 *            faces context.
	...
	public void validate(final FacesContext context, final UIComponent component, final Object value) {
		...
		Pair<String, String> validatorData = (Pair<String, String>) component.getAttributes().get("validationPattern");
