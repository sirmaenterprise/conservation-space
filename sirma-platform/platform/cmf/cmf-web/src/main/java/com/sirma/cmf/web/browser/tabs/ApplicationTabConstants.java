...
/**
 * Class that will holds constants for managing browser tab titles and icons. Here we can define labels for browser tab,
 * path fragments that will be used for detect pages.
 *
 * @author cdimitrov
 */
public class ApplicationTabConstants {
	...
	public static final String CMF_TAB_BROWSE_PROJECTS = "cmf.tab.new.object";
