    ...
    var rv = {debug:null, firefoxJavaVersion:null, myInterval:null, preInstallJREList:null, returnPage:null, brand:null, locale:null, installType:null, EAInstallEnabled:false, EarlyAccessURL:null, getJavaURL:'http://jdl.sun.com/webapps/getjava/BrowserRedirect?host=java.com', appleRedirectPage:'http://www.apple.com/support/downloads/', oldMimeType:'application/npruntime-scriptable-plugin;DeploymentToolkit', mimeType:'application/java-deployment-toolkit', launchButtonPNG:getWebStartLaunchIconURL(), browserName:null, browserName2:null, getJREs:function () {
        ...
        if (this.isPluginInstalled() && this.isAutoInstallEnabled()) {
            ...
            if (this.isCallbackSupported()) {
                installSucceeded = this.getPlugin().installJRE(requestVersion, installCallback);
            } else {
        ...
        return this.isPluginInstalled() && ('MSIE' !== this.browserName || this.compareVersionToPattern(this.getPlugin().version, ["10", "0", "0"], false, true));
...
var attributes = { id:'signApplet', width:"100%", height:"100%",
    style:"position: absolute; z-index: 50;"};
var parameters = {jnlp_href:__CONTEXT_PATH__ + '/resources/js/test.jnlp'};
