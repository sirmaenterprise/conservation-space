 ...
 * @author yasko
 */
public class UsersRestServiceTest extends EmfTest {
	...
	public void testFindById() {
		...
		String expected = readFile("/rest/users/userResponse.json");
	...
	public void testSearchUserAndGroupSearch() {
		...
		String expected = readFile("/rest/users/usersResponse.json");
		...
		expected = readFile("/rest/users/groupsResponse.json");
		JsonAssert.assertJsonEquals(expected, response);
		...
		expected = readFile("/rest/users/groupsAndUsersResponse.json");
		JsonAssert.assertJsonEquals(expected, response);
	}
	 ...
	 */
	private Group createGroup(String groupId, String displayName) {
