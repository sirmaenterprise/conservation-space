...
public class CheckboxFieldBuilderTest extends FormBuilderBaseTest {
	...
	public void buildOutputFieldTest() {
		...
		HtmlSelectBooleanCheckbox outputField = (HtmlSelectBooleanCheckbox) builder.buildOutputField().get(0);
		...
		Assert.assertEquals(outputField.getAttributes().get("styleClass"), BuilderCssConstants.CMF_PREVIEW_FIELD);
