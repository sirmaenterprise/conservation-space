...
public class DateFieldBuilderTest extends FormBuilderBaseTest {
	...
	public DateFieldBuilderTest() {
		...
		Mockito.when(labelProvider.getValue(LabelConstants.DATEPICKER_DATEFORMAT_HINT)).thenReturn(DATE_LABEL);
	...
	public void updateFieldTest() {
		...
		Assert.assertEquals(styleClass, "nameField form-control cmf-date-field date-field");
		...
		Assert.assertEquals(styleClass, "nameField form-control cmf-datetime-field datetime-field");
