...
/**
 * User comparator that sorts the users by their display name using the default format: Given name Family name
 *
 * @author BBonev
 */
public class UserDisplayNameComparator implements Comparator<Resource>, Serializable {
	private static final long serialVersionUID = -2169650668218302169L;
