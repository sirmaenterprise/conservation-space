...
/**
 * Event fired after a work log entry has been deleted successfully. The event will carry all the information available
 * upon deletion.
 *
 * @author BBonev
 */
...
public class DeleteWorkLogEntryEvent implements EmfEvent {
	 ...
	 *            the work log data
	 */
	public DeleteWorkLogEntryEvent(InstanceReference instanceRef, Serializable loggedEntryId, String userId,
			Map<String, Serializable> workLogData) {
