...
/**
 * Event fired when user logs work on a task. The event will carry all passed arguments to the method.
 *
 * @author BBonev
 */
...
public class AddedWorkLogEntryEvent implements EmfEvent {
	 ...
	 *            the properties
	 */
	public AddedWorkLogEntryEvent(InstanceReference instanceRef, Serializable loggedEntryId, String userId,
