...
/**
 * Event fired when an user updates a work log entry in the system. The event will carry the old and the new data also
 * with the information about the user that does the change and the original user logged the work.
 *
 * @author BBonev
 */
...
public class UpdatedWorkLogEntryEvent implements EmfEvent {
	 ...
	 *            the old logged data
	 */
	public UpdatedWorkLogEntryEvent(InstanceReference instanceRef, Serializable updatedEntryId, String updatingUserId,
			String originalUserId, Map<String, Serializable> newLoggedData, Map<String, Serializable> oldLoggedData) {
