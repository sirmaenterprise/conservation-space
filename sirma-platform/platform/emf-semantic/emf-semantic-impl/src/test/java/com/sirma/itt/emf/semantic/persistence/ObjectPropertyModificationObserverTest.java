...
public class ObjectPropertyModificationObserverTest {
	...
	@Test
	public void testOnLinkRemoved() throws Exception {
	...
	@Test
	public void testOnLinkAdded_notActiveContext() throws Exception {
	...
	@Test
	public void testOnLinkRemoved_notActiveContext() throws Exception {
		doThrow(ContextNotActiveException.class).when(changedBuffer).addChange(any());
		observer.onLinkRemoved(new LinkRemovedEvent(link));
	...
	@Test
	public void testOnLinkAdded_notActiveContextWhenGettingResults() throws Exception {
		when(changedBuffer.getChangesAndReset()).thenThrow(ContextNotActiveException.class);
		observer.onLinkAdded(new LinkAddedEvent(link));
