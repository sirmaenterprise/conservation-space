...
public class SemanticPropertyRegisterTest {
	...
	public void setup() {
		...
		when(registryService.buildUri(anyString()))
				.then(a -> new OpenRdfStringUriProxy(a.getArgumentAt(0, String.class)));
	}
	...
	public void provideModelStatements() {
		...
		verify(valueFactory, times(14)).createStatement(any(Resource.class), any(URI.class), any(Resource.class),
				eq(null));
	}
