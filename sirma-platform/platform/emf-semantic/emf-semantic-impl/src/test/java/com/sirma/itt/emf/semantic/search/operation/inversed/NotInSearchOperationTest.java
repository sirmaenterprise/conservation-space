...
public class NotInSearchOperationTest {
	...
	public void testIsApplicable() {
		...
		rule = SearchOperationUtils.createRule("field", "codelist", null, "test");
		Assert.assertFalse(notInSearchOperation.isApplicable(rule));
	}
	...
	public void testBuildOperationWithoutValues() {
		Rule rule = SearchOperationUtils.createRule("field", "codelist", "not_in");
		StringBuilder builder = new StringBuilder();
	...
	public void testBuildOperationWithEmptyValues() {
		Rule rule = SearchOperationUtils.createRule("field", "codelist", "not_in", Collections.emptyList());
		StringBuilder builder = new StringBuilder();
