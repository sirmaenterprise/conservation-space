...
public class SemanticQueryVisitorTest {
	...
	public void initTest() {
		...
		ReflectionUtils.setField(semanticQueryVisitor, "parser", parser);
	}
	...
	private Pair<QueryBoost, Serializable> getConnectorQueryFromPedingPredicates() {
		Map<String, Pair<QueryBoost, Serializable>> pendingPredicates = (Map<String, Pair<QueryBoost, Serializable>>) ReflectionUtils
				.getField(semanticQueryVisitor, "pendingPredicates");
	...
	public void testBuildRegexFullTextSearchClause() throws Exception {
		...
		Map<String, Serializable> bindings = (Map<String, Serializable>) ReflectionUtils.getField(semanticQueryVisitor,
				"bindings");
	...
	public void testBuildIgnoreInstanceByTypeClauseWithNullValue() {
		...
		Assert.assertNull(ReflectionUtils.getField(semanticQueryVisitor, "ignoreInstancesForTypeClause"));
	}
	...
	public void testBuildIgnoreInstanceByTypeClauseWithOneValue() {
		...
		String ignoreInstancesForTypeClause = (String) ReflectionUtils.getField(semanticQueryVisitor,
	...
	public void testBuildIgnoreInstanceByTypeClauseNotApplyFilter() {
		...
		StringBuilder whereClause = (StringBuilder) ReflectionUtils.getField(semanticQueryVisitor, "whereClause");
