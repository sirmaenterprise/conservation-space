...
public class EmptyModel implements Model {
	 ...
	 */
	@Override
	public boolean contains(Resource paramResource, URI paramURI, Value paramValue, Resource... paramArrayOfResource) {
		return false;
	}
	 ...
	 */
	@Override
	public boolean add(Resource paramResource, URI paramURI, Value paramValue, Resource... paramArrayOfResource) {
		return false;
	}
	 ...
	 */
	@Override
	public boolean remove(Resource paramResource, URI paramURI, Value paramValue, Resource... paramArrayOfResource) {
		return false;
	}
	 ...
	 */
	@Override
	public Model filter(Resource paramResource, URI paramURI, Value paramValue, Resource... paramArrayOfResource) {
		return this;
	}
