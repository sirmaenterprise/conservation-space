...
public interface DbDao {
	/** datasource prefix. */
	String DATASOURCE_PREFIX = "java:jboss/datasources/";

	/** Constant for the core persistence unit name. */
	String CORE_PERSISTENCE_UNIT_NAME = "CoreDatabase";
	/** The core operational db datasource name. */
	String CORE_DATASOURCE_NAME = DATASOURCE_PREFIX + SecurityContext.SYSTEM_TENANT;

	/** Constant for the default persistence unit name. */
	String PERSISTENCE_UNIT_NAME = "SEIP-Primary";
	...
	/**
	 * Save or update the given entity in new transaction. If the application provides an previous version of the entity
	 * it will be used to create diff on save. Useful for semantic implementation.
	 *
	 * @param <E>
	 *            the element type
	 * @param entity
	 ...
	 * @return the saved instance.
	 */
	<E extends Entity<? extends Serializable>> E saveOrUpdateInNewTx(E entity, E oldEntity);
	 ...
	 * @return the number of deleted entries
	 */
	default <E extends Entity<? extends Serializable>> int deleteInNewTx(Class<E> clazz, Serializable entityId) {
		return deleteInNewTx(clazz, entityId, true);
	}
	...
	/**
	 * Deletes entity instance from the DB in new transaction. If the entity and or model supports soft delete it should
	 * consider the value of the parameter {@code softDelete}.
	 *
	 * @param <E>
	 *            the element type
	 * @param clazz
	 ...
	 * @return the number of deleted entries
	 */
	<E extends Entity<? extends Serializable>> int deleteInNewTx(Class<E> clazz, Serializable entityId,
			boolean softDelete);
