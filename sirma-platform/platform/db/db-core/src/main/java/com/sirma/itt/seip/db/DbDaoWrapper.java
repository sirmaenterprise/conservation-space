...
public class DbDaoWrapper implements DbDao {
	 ...
	 */
	public DbDaoWrapper(DbDao primary, DbDao secondary) {
	...
	@Override
	public <E extends Entity<? extends Serializable>> E saveOrUpdateInNewTx(E entity, E oldEntity) {
		E result = primary.saveOrUpdateInNewTx(entity, oldEntity);
		secondary.saveOrUpdateInNewTx(entity, oldEntity);
		return result;
	}
	...
	@Override
	public <E extends Entity<? extends Serializable>> int deleteInNewTx(Class<E> clazz, Serializable entityId) {
		int result = primary.deleteInNewTx(clazz, entityId);
		secondary.deleteInNewTx(clazz, entityId);
		return result;
	}
	...
	public <E extends Entity<? extends Serializable>> int deleteInNewTx(Class<E> clazz, Serializable entityId,
			boolean softDelete) {
		int result = primary.deleteInNewTx(clazz, entityId, softDelete);
		secondary.deleteInNewTx(clazz, entityId, softDelete);
		return result;
	}
