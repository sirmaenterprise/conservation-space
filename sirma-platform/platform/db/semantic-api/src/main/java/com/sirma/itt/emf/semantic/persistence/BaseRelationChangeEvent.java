...
public abstract class BaseRelationChangeEvent implements ObjectPropertyEvent {
	...
	private final Function<URI, String> shortUriConverter;
	 ...
	 */
	public BaseRelationChangeEvent(LocalStatement statementTrigger, Function<URI, String> shortUriConverter) {
	...
	public Serializable getSourceId() {
		return shortUriConverter.apply((URI) statement.getStatement().getSubject());
	}
	...
	public Serializable getTargetId() {
		return shortUriConverter.apply((URI) statement.getStatement().getObject());
	}
