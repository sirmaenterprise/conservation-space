 ...
 * building property full URI string-representation according to its short definition.
 * </p>
 * <p>
 * The built string-representation of a full URI could be used for creating RDF {@link org.openrdf.model.Literal}s by
 * using a {@link org.openrdf.model.ValueFactory}
 * </p>
 *
...
public interface NamespaceRegistryService {
	...
	/**
	 * <p>
	 * Builds the property full URI string-representation according to its short definition. The property <b>short
	 * URI</b> is represented by a string in the following format {@code prefix:property}
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Builds short by given full URI, according to the cached namespaces and their prefixes in the underlying semantic
	 * repository.
	 * </p>
	 * <p>
	 * For example, if the {@code PREFIX dcterms:<http://purl.org/dc/terms/>} is defined in the semantic repository,
	...
	/**
	 * <p>
	 * Builds short by given full URI given as String, according to the cached namespaces and their prefixes in the
