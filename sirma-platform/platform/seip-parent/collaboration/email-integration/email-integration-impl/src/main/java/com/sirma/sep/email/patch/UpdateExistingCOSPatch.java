...
/**
 * Patch which get tenant domain COS and update it's properties
 *
 * @author S.Djulgerova
 */
@Singleton
public class UpdateExistingCOSPatch implements CustomTaskChange {
	...
	public void execute(Database database) throws CustomChangeException {
		...
		try {
			...
			domainAdministrationService.modifyCos(cosId, ZimbraEmailIntegrationConstants.ALLOW_FROM_ADDRESS, "TRUE");
			domainAdministrationService.modifyCos(cosId, ZimbraEmailIntegrationConstants.COMPOSE_IN_NEW_WINDOW_ENABLED,
					"FALSE");
