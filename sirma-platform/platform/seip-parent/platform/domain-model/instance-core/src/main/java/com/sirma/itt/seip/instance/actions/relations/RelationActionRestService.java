...
public class RelationActionRestService {
    ...
    /**
     * Executes operation that update (add/remove) relations between the current instance and the specified instance ids.
     * <p>
     * Typical request is:
     * <pre>
     *         <code>
     ...
     *
     * @param request
     *         {@link UpdateRelationsRequest} containing the information for the operation, like - user operation,
     *         context path, placeholder, etc.
     * @return
     */
    @POST
