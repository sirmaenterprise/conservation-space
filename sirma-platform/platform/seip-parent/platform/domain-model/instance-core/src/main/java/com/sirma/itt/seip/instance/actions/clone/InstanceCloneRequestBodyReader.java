 ...
 * <p>
 * Created by Ivo Rusev on 14.12.2016 г..
 */
@Provider
...
public class InstanceCloneRequestBodyReader implements MessageBodyReader<InstanceCloneRequest> {
    ...
    @Override
    public InstanceCloneRequest readFrom(Class<InstanceCloneRequest> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream) {
