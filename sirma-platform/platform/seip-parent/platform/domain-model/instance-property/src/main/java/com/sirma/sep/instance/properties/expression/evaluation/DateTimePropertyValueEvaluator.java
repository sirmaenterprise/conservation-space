 ...
 * @author A. Kunchev
 */
@Extension(target = PropertyValueEvaluator.PLUGIN_NAME, order = 60)
public class DateTimePropertyValueEvaluator implements PropertyValueEvaluator {
	...
	public boolean canEvaluate(PropertyDefinition source, PropertyDefinition destination) {
		return PropertyDefinition.hasType(DataTypeDefinition.DATETIME).test(source)
