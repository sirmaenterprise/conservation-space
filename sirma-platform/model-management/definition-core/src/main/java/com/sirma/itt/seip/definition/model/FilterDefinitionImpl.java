...
public class FilterDefinitionImpl implements Filter, Serializable {
	...
	static final String QUERY_FILTER_BY_ID = "select l from FilterDefinitionImpl l where l.identifier=:filterId";

	/** Get {@link FilterDefinitionImpl}s by filterIds */
	public static final String QUERY_FILTERS_BY_ID_KEY = "QUERY_FILTERS_BY_ID";
	static final String QUERY_FILTERS_BY_ID = "select l from FilterDefinitionImpl l where l.identifier in (:filterId)";
