...
public class XmlError implements Serializable {
	 ...
	 */
	public XmlError(String message, XmlErrorLevel level, int lineNumber, int colNumber) {
		this.message = message;
		this.level = level;
	...
	public String toString() {
		return "XmlError [colNumber=" + colNumber + ", level=" + level + ", lineNumber=" + lineNumber + ", message="
				+ message + "]";
	}
