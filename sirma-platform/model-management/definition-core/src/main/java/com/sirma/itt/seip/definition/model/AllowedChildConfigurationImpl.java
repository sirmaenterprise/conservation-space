...
public class AllowedChildConfigurationImpl extends MergeableBase<AllowedChildConfigurationImpl>
		implements Serializable, AllowedChildConfiguration, Cloneable, Sealable {
	...
	@Override
	public AllowedChildConfigurationImpl clone() {
		try {
			AllowedChildConfigurationImpl clone = (AllowedChildConfigurationImpl) super.clone();
			clone.sealed = false;
