...
public class FieldDefinitionImpl extends MergeableBase<FieldDefinitionImpl>implements PropertyDefinition, Serializable,
		Cloneable, BidirectionalMapping, WritablePropertyDefinition, Sealable, Comparable<PropertyDefinition> {
	...
	public String getLabel() {
		...
		if (labelProvider != null) {
			if (labelid == null) {
				LOGGER.warn("Requesting a label from a field '" + getIdentifier() + "' that does not have a label");
				return labelid;
			}
	...
	public FieldDefinitionImpl clone() {
		...
		if (getConditions() != null) {
			...
			for (Condition condition : getConditions()) {
				definition.getConditions().add(((ConditionDefinitionImpl) condition).clone());
			}
		}
		return definition;
	}
