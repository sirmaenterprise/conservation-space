...
public interface DefinitionCompilerAlgorithm {
	...
	/**
	 * The method is called before any compilations. The implementation should reset any internal state and be prepared
	 * for next steps. If any pre-loading should be done it can be done here.
	 *
	 * @param callback
	 *            the callback
	 */
	...
	/**
	 * The actual compilation. The method should compile the given list of definitions. Note that the given list may be
	 * not the same returned from the method {@link #loadFiles(DefinitionCompilerCallback)}.
	 *
	 * @param definitions
