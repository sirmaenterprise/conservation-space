...
/**
 * Utility class for extracting and constructing complex key from the definition's id/parent id and container.
 *
 * @author BBonev
 */
public class DefinitionIdentityUtil {
	...
	public static String createDefinitionId(TopLevelDefinition definition) {
		...
		if (com.sirma.itt.commons.utils.string.StringUtils.isNotNullOrEmpty(definition.getContainer())) {
	...
	public static String createReferenceDefinitionId(ReferenceDefinitionModel definition) {
		...
		if (definition instanceof TenantAware && com.sirma.itt.commons.utils.string.StringUtils
	...
	public static Pair<String, String> parseDefinitionId(String definitionId) {
		...
		return new Pair<>(getDefinitionId(definitionId), getContainerId(definitionId));
	}
	...
	public static Pair<String, String> createDefinitionPair(TopLevelDefinition definition) {
		...
		return new Pair<>(definition.getIdentifier(), container);
	}
