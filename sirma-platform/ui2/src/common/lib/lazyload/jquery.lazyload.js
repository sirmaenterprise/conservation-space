 ...
 *
 */
const LAZYLOAD_UPDATE = 'LAZYLOAD_GLOBAL_UPDATE';
...
(function($, window, document, undefined) {
    ...
    $.fn.lazyload = function(options) {
        ...
        // update view when image is loaded and takes
        // its appropriate width and height on the viewport
        $container.one(LAZYLOAD_UPDATE, update);
                    ...
                    $("<img />")
                        .one("load", function() {
                          $self.one('load',function() {
                            // post global message after original src is loaded.
                            $container.trigger(LAZYLOAD_UPDATE)
                          });
