...
export class UploadRevisionAction extends InstanceAction {
  ...
  execute(actionDefinition, context) {
    return this.uploadDialogConfigurator.createDialog(actionDefinition, context.currentObject, this.instanceRestService.getRevisionUploadUrl(context.currentObject.id), true, true);
  }
}
