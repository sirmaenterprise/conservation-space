...
export class PublishAsPdfAction extends InstanceAction {
  ...
  execute(action, context) {
    ...
    return this.actionsService.publishAsPdf(currentObjectId, this.buildActionPayload(action, context.currentObject, action.action)).then((response) => {
