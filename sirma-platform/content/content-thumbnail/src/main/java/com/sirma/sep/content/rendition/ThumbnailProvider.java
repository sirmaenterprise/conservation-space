...
public interface ThumbnailProvider extends Plugin, Named {
	...
	/**
	 * Creates a thumbnail end point from the given source {@link Instance} identifier. If the method returns <code>null</code> the
	 ...
	 */
	String createThumbnailEndPoint(Serializable source);
