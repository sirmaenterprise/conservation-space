	...
	private SpreadsheetOperationReport generateResult(InstanceReference spreadsheet,
		...
		securityContextManager.executeAsSystem().executable(() -> {
			...
			Content reportContent = Content
					.createEmpty()
						.setContent(validationReport.get().toString(), (String) null)
			...
			report.add(CONTENT_LENGTH, Long.valueOf(savedContent.getLength()));
