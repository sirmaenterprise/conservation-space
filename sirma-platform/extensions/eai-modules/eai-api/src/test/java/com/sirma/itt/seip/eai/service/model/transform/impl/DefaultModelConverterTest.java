...
public class DefaultModelConverterTest {
	...
	public void setupMocks(DefaultModelConverter defaultModelConverter) throws Exception {
		...
		ReflectionUtils.setField(defaultModelConverter, "dictionaryService", dictionaryService);
		ReflectionUtils.setField(defaultModelConverter, "codelistService", codelistService);
		ReflectionUtils.setField(defaultModelConverter, "typeConverter", typeConverter);
		ReflectionUtils.setField(defaultModelConverter, "integrationService", integrationService);
		...
		when(configurationProvider.getModelConfiguration())
				.thenReturn(new ConfigurationPropertyMock<ModelConfiguration>(modelConfigaration));
		when(integrationService.getIntegrationConfiguration(SYSTEM_ID)).thenReturn(configurationProvider);
	}

	/**
	 * Test method for
	 * {@link com.sirma.itt.seip.eai.service.model.transform.impl.DefaultModelConverter#convertSEIPtoExternalProperty(java.lang.String, java.io.Serializable, java.lang.String, com.sirma.itt.seip.eai.model.mapping.EntityProperty.EntityPropertyMapping)}
	 * .
	 */
	...
	private DefaultModelConverter createConverter() {
	...
	/**
	 * Test method for
	 * {@link com.sirma.itt.seip.eai.service.model.transform.impl.DefaultModelConverter#convertSEIPtoExternalProperty(java.lang.String, java.io.Serializable, java.lang.String)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.sirma.itt.seip.eai.service.model.transform.impl.DefaultModelConverter#convertExternaltoSEIPProperty(java.lang.String, java.io.Serializable, java.lang.String)}
	 * .
	 */
	@Test
	public void testConvertExternaltoSEIPProperty() throws Exception {
		...
		when(dictionaryService.find("CO0001")).thenReturn(definitionModel);
