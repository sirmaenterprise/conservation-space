...
public class ExternalSystemSearchEngineTest {
	...
	public void setupMocks() throws Exception {
		...
		ReflectionUtils.setField(externalSystemSearchEngine, "communicationService", communicationService);
		ReflectionUtils.setField(externalSystemSearchEngine, "requestProvider", requestProvider);
		ReflectionUtils.setField(externalSystemSearchEngine, "responseReader", responseReader);
		ReflectionUtils.setField(externalSystemSearchEngine, "integrationService", integrationService);
	}
	...
	public void search() throws Exception {
		...
		Condition searchTree = new Condition();
		searchTree.setCondition(Junction.AND);
		searchTree.setRules(new LinkedList<>());
		...
		when(mockResponseAdapter.parseResponse(Mockito.any(ResponseInfo.class)))
				.thenAnswer(new Answer<ProcessedInstanceModel>() {

					@Override
					public ProcessedInstanceModel answer(InvocationOnMock invocation) throws Throwable {
		...
		when(mockCommunicationAdapter.invoke(Mockito.any(RequestInfo.class))).thenAnswer(new Answer<ServiceResponse>() {
	...
	public void searchWithError() throws Exception {
		...
		when(eaiConfigurationProvider.getSystemClientId()).thenReturn(new ConfigurationPropertyMock<String>("id:id"));
