...
public class EAISearchModelRestService {
	...
	public SearchModelConfiguration provideSearchModel(@PathParam("systemId") String systemId) {
		try {
			...
			throw new RestServiceException(String.format(ERROR_MSG, systemId), Status.INTERNAL_SERVER_ERROR, e);
		}
	}
	...
	private static String detectType(EntityProperty propertyByCriteration) {
		...
		// return the detected type or the default value
		return type != null ? type.getDataTypeDefinitionName() : propertyByCriteration.getType();
	}
