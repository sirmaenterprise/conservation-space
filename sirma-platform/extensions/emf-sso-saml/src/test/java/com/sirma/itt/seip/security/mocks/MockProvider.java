...
public class MockProvider {
	...
	public static SystemUserAuthenticator provideSystemAuthenticator() {
		...
		ReflectionUtils.setField(authSystem, "systemConfiguration", systemConfiguration);
		...
		ReflectionUtils.setField(authSystem, "idpConfiguration", idpConfiguration);
		...
		ReflectionUtils.setField(authSystem, "samlMessageProcessor", samlMessageProcessor);
		return authSystem;
	}
}
