...
public class ContentMatcherTest extends EmfTest {
	...
	public void beforeMethod() {
		super.beforeMethod();
		Mockito.when(contentService.loadTextContent(Matchers.any(Instance.class))).then(invocation -> {
			Instance instance = (Instance) invocation.getArguments()[0];
			return (String) instance.getProperties().get(DefaultProperties.CONTENT);
		});
	}
