 ...
 * @author BBonev
 */
public interface RuleOperation extends Named, SupportablePlugin, Configurable, DynamicSupportable, Applicable {
	 ...
	 * {@link #execute(Context, Instance, Context)} method and {@link #processingEnded(Context)} and could be used to
	 * store/collect information during the rule processing.
	 *
	 * @param context
