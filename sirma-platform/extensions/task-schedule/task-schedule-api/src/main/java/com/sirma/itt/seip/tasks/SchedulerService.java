...
public interface SchedulerService {
	...
	/**
	 * Load and activate schedule instance entries by identifiers. The activation means that the status is changed to
	 * {@link SchedulerEntryStatus#RUNNING} before returning from the method. This should be called when the entries are
