...
public class SchedulerRestService {
	...
	public Response listActiveAsyncTasks() {
		...
		Collection<JSONObject> archive = typeConverter.convert(JSONObject.class, timedExecutor.getArchiveTasks());
		...
		JsonUtil.addToJson(object, "active", new JSONArray(active));
		JsonUtil.addToJson(object, "archive", new JSONArray(archive));
