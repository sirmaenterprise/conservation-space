...
public abstract class ScriptTest extends EmfTest {
	...
	protected ScriptEvaluatorImpl createEvaluator() {
		if (scriptEvaluator == null) {
			...
			ReflectionUtils.setField(scriptEvaluator, "scriptEngineManager", provider.provide());
			ReflectionUtils.setField(scriptEvaluator, "scriptEngineName",
	...
	protected ScriptEngineManagerProvider createEngineProvider() {
		...
		ReflectionUtils.setField(provider, "globalBindings", bindingsExtensions);
		return provider;
	}
	...
	protected void provideBindings(List<GlobalBindingsExtension> bindingsExtensions) {
		...
		ReflectionUtils.setField(converterExtension, "typeConverter", converter);
