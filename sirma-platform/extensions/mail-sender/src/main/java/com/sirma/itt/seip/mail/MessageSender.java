...
public class MessageSender {
	...
	@ConfigurationGroupDefinition(type = MailSender.class, properties = { MAIL_SERVER_HOST, MAIL_SERVER_PORT,
			MAIL_USER_NAME, MAIL_PASSWORD, MAIL_SECURITY_TYPE,
	...
	static MailSender buildSender(GroupConverterContext context, MailAttachmentService attachmentService) {
		...
		String password = context.get(MAIL_PASSWORD);
	 ...
	 */
	static MailConfiguration buildOutgoingConfiguration(String host, Integer port, String from, String securityType) {
	...
	public void sendMessage(MailMessage message) {
		if (StringUtils.isNullOrEmpty(message.getFrom())) {
	...
	MailMessage constructMessage(String message, String subject, String mailGroupId, String from, String[] recepients, String[] ccRecipients,
			MailAttachment[] attachments) {
