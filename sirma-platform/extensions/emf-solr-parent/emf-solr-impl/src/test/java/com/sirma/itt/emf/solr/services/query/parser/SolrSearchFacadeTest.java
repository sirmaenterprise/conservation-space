...
public class SolrSearchFacadeTest {
	...
	public void setUp() {
		...
		ReflectionUtils.setField(solrSearchFacade, "namespaceRegistryService", namespaceRegistryService);
		...
		ReflectionUtils.setField(dateConverter, "dateFormats", ContextualMap.create());
		ReflectionUtils.setField(dateConverter, "converterDateFormatPattern",
				new ConfigurationPropertyMock<>("dd.MM.yyyy"));
		ReflectionUtils.setField(dateConverter, "converterDatetimeFormatPattern",
