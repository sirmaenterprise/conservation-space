...
public interface FtpClient {
	...
	/**
	 * Enumeration of possible states for asynchronous operations
	 *
	 * @author BBonev
	 */
	enum OperationStatus {
		...
		RUNNING, /** The operation had completed successfully. */
		COMPLETED, /** The operation failed to complete. */
		FAILED;
	}
	...
	/**
	 * Gets the status of asynchronous operation if it's completed or failed.
	 *
	 * @param requestId
	 *            the request id
	 * @return true, if is async operation completed
	 */
	OperationStatus getAsyncOperationStatus(Serializable requestId);
	 ...
	 *            the request id
	 */
	void cancelAsyncRequest(Serializable requestId);
}
