...
public class AlfrescoUtils {
	...
	public static final <V extends Serializable> Map<String, V> jsonObjectToMap(JSONObject jsonObject)
			throws JSONException {
		Map<String, V> result = CollectionUtils.createHashMap(jsonObject.length());
	...
	private static <T extends Serializable> T toList(JSONArray value) throws JSONException {
		JSONArray arr = value;
		Collection<Object> collection = new ArrayList<>(arr.length());
