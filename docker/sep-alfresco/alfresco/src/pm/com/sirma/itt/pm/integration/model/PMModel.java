...
public interface PMModel {
	...
	QName TYPE_PM_PROJECT_DEF_SPACE = QName.createQName(PM_MODEL_1_0_URI, "definitionspace");
	/** The type cmf project instance space. */
	QName TYPE_PM_PROJECT_INSTANCES_SPACE = QName.createQName(PM_MODEL_1_0_URI, "instancesspace");
