...
public class WorkflowServiceImpl implements WorkflowService {
	...
	public WorkflowPath startWorkflow(String workflowDefinitionId,
		...
		if (getWorkflowReportService() != null) {
			getWorkflowReportService().addTask(path);
		}
		return path;
	}
	 ...
	 * 
	 * @see
	 * org.alfresco.service.cmr.workflow.WorkflowService#getWorkflows(org.alfresco
	...
	public List<WorkflowInstance> cancelWorkflows(List<String> workflowIds) {
		...
		for (Map.Entry<String, List<String>> entry : workflows.entrySet()) {
			...
			for (WorkflowInstance instance : instances) {
				...
				result.add(instance);
				if (getWorkflowReportService() != null) {
					getWorkflowReportService().cancelWorkflow(instance);
				}
			}
		}
		return result;
	...
	public WorkflowInstance deleteWorkflow(String workflowId) {
		...
		// workflowPackageComponent.deletePackage(instance.getWorkflowPackage());
		if (getWorkflowReportService() != null) {
			getWorkflowReportService().deleteWorkflow(workflowId);
		}
		return instance;
	}
	 ...
	 * 
	 * @see
	 * org.alfresco.service.cmr.workflow.WorkflowService#getStartTasks(java.
	 * util.List, boolean)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.alfresco.service.cmr.workflow.WorkflowService#hasWorkflowImage(
	 * java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.alfresco.service.cmr.workflow.WorkflowService#getWorkflowImage(
	 * java.lang.String)
	 */
	@Override
	...
	public WorkflowTask updateTask(String taskId, Map<QName, Serializable> properties,
		...
		if (getWorkflowReportService() != null) {
			getWorkflowReportService().updateTask(task);
		}
		return task;
	}
	...
	/*
	 * @see
	 * org.alfresco.service.cmr.workflow.WorkflowService#isTaskEditable(org.
	...
	/*
	 * @see
	 * org.alfresco.service.cmr.workflow.WorkflowService#isTaskReassignable(
	...
	/*
	 * @see
	 * org.alfresco.service.cmr.workflow.WorkflowService#isTaskClaimable(org
	 * .alfresco.service.cmr.workflow.WorkflowTask, java.lang.String)
	 */
	/*
	 * (non-Javadoc)
	...
	/*
	 * @see
	 * org.alfresco.service.cmr.workflow.WorkflowService#isTaskReleasable(org
	 * .alfresco.service.cmr.workflow.WorkflowTask, java.lang.String)
	 */
	/*
	 * (non-Javadoc)
	 ...
	 * 
	 * @see
	 * org.alfresco.service.cmr.workflow.WorkflowService#getPackageContents(
	 * java.lang.String)
	 */
	@Override
	...
	/**
	 * Determines if the given user is a member of the pooled actors assigned to
	 * the task.
	 * 
	 * @param task
	...
	/**
	 * Determines if the given user is the owner of the given task or the
	 * initiator of the workflow the task is part of.
	 * 
	 * @param task
	 *            The task to check
	 * @param username
	...
	/**
	 * Returns the username of the user that initiated the workflow the given
	 * task is part of.
	 * 
	 * @param task
	...
	private String getWorkflowInitiatorUsername(WorkflowTask task) {
		...
		if (initiatorRef != null && this.nodeService.exists(initiatorRef)) {
			initiator = (String) this.nodeService.getProperty(initiatorRef,
	...
	public WorkflowReportService getWorkflowReportService() {
		if (workflowReportService == null) {
			workflowReportService = (WorkflowReportService) services.getService(QName.createQName(
					NamespaceService.ALFRESCO_URI, "qviTaskReportService"));
			ActivitiWorkflowEngine workflowComponent = (ActivitiWorkflowEngine) getWorkflowComponent("activiti");
			workflowComponent.setWorkflowReportService(workflowReportService);
