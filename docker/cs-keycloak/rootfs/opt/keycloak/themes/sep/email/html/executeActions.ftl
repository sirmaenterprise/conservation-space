...
<head>
    ...
    <![endif]-->
	<script>
		function extractTenantId(link) {
			let start = link.indexOf('/realms/') + '/realms/'.length;
			let end = link.indexOf('/login-actions/');
...
<center>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%;">
                                      <tr>
                                        <td align="left" class="textContent">
											<!-- SMALL NOTIFICATION BEFORE CONTENT -->
                                          <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
											${msg("emailNotificationText")} <a href="#" target="_blank" style="text-decoration:none;border-bottom:1px solid #828282;color:#828282;"><span style="color:#828282;">${msg("emailNotificationLinkText")}</span></a>.
                                          </div>
                                        </td>
                                      </tr>
                                    </table>
 ...
 <!-- HEADER -->
              <tr>
                <td align="center" valign="top">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#33363F">
                    <tr>
                      <td align="center" valign="top">
										...
										<tr>
										  <td valign="top" class="textContent">
											...
											<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">											
												<script>
													setTimeout(function() {
														let tenant = extractTenantId('${link}');
														let span = document.getElementById('tenantId');
														span.innerHTML = tenant;
													}, 10);													
												</script>
												${kcSanitize(msg("executeActionsBodyCustomHtml", user.firstName, user.username, realmName, linkExpirationFormatter(linkExpiration)))?no_esc}
											</div>
										   </td>
										</tr>
									</table>

								<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #33363F;">
										<tr>
										  <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
											<a href="${link}">
												${msg("executeActionsLink")}
											</a>
										  </td>
										</tr>
								</table>
                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" bgcolor="#E1E1E1">
                                     ...
                                     <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                     <div>${kcSanitize(msg("poweredByHtml"))?no_esc}</div>
                                    </div>
