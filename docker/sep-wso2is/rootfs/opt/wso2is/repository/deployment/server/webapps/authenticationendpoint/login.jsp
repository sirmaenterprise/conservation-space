...
<fmt:bundle basename="org.wso2.carbon.identity.application.authentication.endpoint.i18n.Resources">
    ...
    <head>
        <meta charset="utf-8">
        <title>SEP Login page</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="">
        <meta name="author" content="">
		<link rel="shortcut icon" type="image/x-icon" href="/authenticationendpoint/images/sep-favicon.png" />
	...
	<div class="popup-layout">
	  <div class="popup-content">
		<div class="popup-center-horizontal">
			<div class="bottom-space">
				<!-- The main logo on center of the page.
				~ 	 If you want to change it just replace the image logo.png in the images folder
				-->
...
<%} %>
		...
		<% if ("true".equals(loginFailed)) { %>
				...
				<div class="center-content alert alert-error" style="margin-bottom: 10px;">
					<%=errorMessage%>
				</div>
  ...
  <div class="container">
	...
	<!-- Powered by logo on the bottom right of the page.
	~ 	 If you want to remove it, just comment the next div or delete it.
	~	 Or if you want to change the image, just replace the image powered-by-logo.jpg
	~	 in images folder.
	-->
	<div id="powered-by-logo">
		<img src="images/powered-by-logo.jpg" />
	</div>
