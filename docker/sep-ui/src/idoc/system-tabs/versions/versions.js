...
@Inject(InstanceRestService, Configuration, MomentAdapter, TranslateService, NgScope, NotificationService, PromiseAdapter)
export class Versions {
  constructor(instanceRestService, configuration, momentAdapter, translateService, $scope, notificationService, promiseAdapter) {
