...
/**
 * Patch which get tenant domain COS and update it's property to disable GAL to be selected/deselected and used in
 * searches
 *
 * @author S.Djulgerova
 */
@Singleton
public class DisableGalAccessPatch implements CustomTaskChange {
	...
	public void execute(Database database) throws CustomChangeException {
		...
		try {
			...
			domainAdministrationService.modifyCos(cosId, ZimbraEmailIntegrationConstants.ENABLE_GAL_FEATURE, "FALSE");
			domainAdministrationService.modifyCos(cosId, ZimbraEmailIntegrationConstants.ENABLE_GAL_SEARCH, "FALSE");
