...
/**
 * Test for {@link DisableGalAutocompletePatch}.
 *
 * @author S.Djulgerova
 */
public class DisableGalAutocompletePatchTest {

	@InjectMocks
	private DisableGalAutocompletePatch disableGalAutocompletePatch;
	...
	public void setUp() throws SetupException {
		disableGalAutocompletePatch = new DisableGalAutocompletePatch();
	...
	public void testCOSUpdate() throws CustomChangeException, EmailIntegrationException {
		...
		disableGalAutocompletePatch.execute(null);
		verify(domainAdministrationService, times(1)).modifyCos("123456",
				ZimbraEmailIntegrationConstants.ENABLE_GAL_AUTOCOMPLETE, "FALSE");
	}
