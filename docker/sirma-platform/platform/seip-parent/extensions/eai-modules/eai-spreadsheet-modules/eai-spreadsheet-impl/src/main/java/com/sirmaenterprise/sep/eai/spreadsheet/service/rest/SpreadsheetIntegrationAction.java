...
public class SpreadsheetIntegrationAction implements Action<SpreadsheetDataIntegrataionRequest> {
	...
	/**
	 * Lock data import source instance while the action execution to prevent any execution of other actions over that
	 * instance.
	 */
	@Override
	public boolean shouldLockInstanceBeforeAction(SpreadsheetDataIntegrataionRequest request) {
		return true;
	}
}