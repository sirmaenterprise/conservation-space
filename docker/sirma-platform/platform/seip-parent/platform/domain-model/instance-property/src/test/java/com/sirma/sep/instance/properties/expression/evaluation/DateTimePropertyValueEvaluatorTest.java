...
import com.sirma.sep.instance.properties.expression.evaluation.DateTimePropertyValueEvaluator;
import com.sirma.sep.instance.properties.expression.evaluation.UserDateConverter;

/**
 * Test for {@link DateTimePropertyValueEvaluator}.
 *
 * @author <a href="mailto:ivo.rusev@sirma.bg">Ivo Rusev</a>
 * @since 17/07/2017
 */
public class DateTimePropertyValueEvaluatorTest {

	@InjectMocks
	private DateTimePropertyValueEvaluator cut;
	@Mock
	...
	@Before
	public void init() {
		cut = new DateTimePropertyValueEvaluator();
	...
	public void test_evaluate() {
		...
		assertEquals("formatted-date-time", fieldName);
