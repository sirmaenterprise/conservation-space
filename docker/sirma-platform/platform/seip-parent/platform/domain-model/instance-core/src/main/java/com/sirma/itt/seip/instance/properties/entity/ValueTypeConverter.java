...
public class ValueTypeConverter {
	...
	/**
	 * Converts passed value to specified {@link ValueType}.
	 *
	 * @param type to which the value should be converted
	 * @param value to convert to specific type
	 * @return the passed value converted to specified type. May return <code>null</code> if the passed value is null or
	 *         could not be converted
	 */
	public static Serializable convertValue(ValueType type, Serializable value) {
