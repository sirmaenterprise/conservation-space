...
public interface SearchOperation extends Plugin {
	 ...
	 */
	default void buildOperation(StringBuilder builder, Rule rule) {
	 ...
	 */
	default void buildOperation(StringBuilder builder, Rule rule, SearchContext searchContext) {
		buildOperation(builder, rule);
	}
