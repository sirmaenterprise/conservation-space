...
public class NotSetToQuerySearchOperationTest {
	...
	@InjectMocks
	private NotSetToQuerySearchOperation operation;
	...
	public void testBuildOperation() {
		...
		Pattern pattern = Pattern.compile(
				" FILTER \\( NOT EXISTS  \\{  \\?instance (?!\\?instance).* (?!\\?instance).*\\..* emf:isDeleted \"false\"\\^\\^xsd:boolean \\.  "
						+ QuerySearchOperationTestHelper.PATTERN_INSTANCE_TYPES + System.lineSeparator()
						+ "(?!\\?instance).* emf:Relation emf:Admin\\.\\} \\) ");
