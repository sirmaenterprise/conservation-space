...
/**
 * Builder that is responsible for building concrete configuration objects. The
 * concrete implementation class will be loaded via Java Service API but will be
 * instantiated as a CDI bean if it's valid one. This is the main class that
 * need to be provided for the configuration extension to replace the default
...
public interface ConfigurationBuilder {
	...
	/**
	 * Builds the property instance for the given configuration instance using
	 ...
	 *            the configuration value provider that is responsible for the
	 *            raw value provisioning
	 * @param converterProvider
	 *            the converter provider responsible for property converter
	 *            provisioning
	 * @param configurationProvider
	 *            the configuration provider that is responsible for
	 *            provisioning other configuration property values.
