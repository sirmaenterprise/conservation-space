 ...
 * @author BBonev
 */
@Extension(target = DefintionAdapterServiceExtension.TARGET_NAME, order = 10)
public class CmfDefintionAdapterServiceExtension implements DefintionAdapterServiceExtension {
