...
class ImageServerConfigImpl implements ImageServerConfigurations {
	...
	@ConfigurationPropertyDefinition(label = "Replace the colors in image tool's color palette.")
	private static final String IMAGE_TOOL_PALETTE_REPLACE = "image_tool.color_palette.replace";
	
	@ConfigurationPropertyDefinition(label = "Add to the colors in the image tool's color palette.")
	private static final String IMAGE_TOOL_PALETTE_EXTEND = "image_tool.color_palette.extend";
