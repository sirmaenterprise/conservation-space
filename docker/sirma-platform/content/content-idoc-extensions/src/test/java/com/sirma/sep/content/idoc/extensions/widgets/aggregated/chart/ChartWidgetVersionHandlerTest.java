...
/**
 * Test class for {@link ChartWidgetVersionHandler}
 *
 * @author hlungov
 */
public class ChartWidgetVersionHandlerTest {

	private static final String VERSION_TEST_PREFIX = "version-";

	@InjectMocks
	private ChartWidgetVersionHandler handler;
	...
	public void handle_noSearchResults() {
		...
		ContentNodeHandler.HandlerContext context = new ContentNodeHandler.HandlerContext();
	...
	public void handle_noVersionDate() {
		...
		handler.handle(widget, new ContentNodeHandler.HandlerContext());
