...
import com.sirma.sep.content.idoc.extensions.widgets.objectlink.ObjectLinkWidgetRevertHandler;
...
/**
 * Test for {@link ObjectLinkWidgetRevertHandler}.
 *
 * @author A. Kunchev
 */
public class ObjectLinkWidgetRevertHandlerTest {

	private ObjectLinkWidgetRevertHandler handler;

	@Before
	public void setup() {
		handler = new ObjectLinkWidgetRevertHandler();
	}
