...
import com.sirma.sep.content.idoc.extensions.widgets.contentviewer.ContentViewerWidgetVersionHandler;
...
/**
 * Test for {@link ContentViewerWidgetVersionHandler}.
 *
 * @author A. Kunchev
 */
public class ContentViewerWidgetVersionHandlerTest {

	private ContentViewerWidgetVersionHandler handler;

	@Before
	public void setup() {
		handler = new ContentViewerWidgetVersionHandler();
	}
