...
@Inject(NgScope, NgElement, ExternalObjectService, InstanceRestService, TranslateService, Eventbus)
export class ResultsWithActions extends Configurable {

  constructor($scope, $element, externalObjectService, instanceRestService, translateService, eventbus) {
