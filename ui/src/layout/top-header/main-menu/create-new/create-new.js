...
@Inject(CreatePanelService, NgScope, WindowAdapter, IdocContextFactory, DialogService, TranslateService)
export class CreateNew {

  constructor(createPanelService, $scope, windowAdapter, idocContextFactory, dialogService, translateService) {
