...
export class CommentContentDialog {
  ...
  getDialogButtons(config) {
    ...
    return [
      {
        id: CommentContentDialog.SAVE_ACTION_ID,
      ...
      {
        id: CommentContentDialog.CANCEL_ACTION_ID,
...
CommentContentDialog.SAVE_ACTION_ID = 'SAVE';
CommentContentDialog.CANCEL_ACTION_ID = 'CANCEL';