...
export class ImageCommentsSection {
  ...
  subscribeToEvents() {
    ...
    this.events.push(this.eventbus.subscribe(CommentsFilteredEvent, this.handleCommentsFilteredEvent.bind(this)));
  ...
  applyFilter() {
    if (!_.isEqual(EMPTY_FILTERS, this.config.filterConfig.filters)) {
