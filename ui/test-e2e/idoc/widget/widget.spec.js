...
describe('Widget', function () {
  ...
  it('should allow editing its title in edit mode', function () {
    ...
    browser.wait(EC.textToBePresentInElement(helloWidget.titleElement, TITLE), DEFAULT_TIMEOUT);

    return expect(helloWidget.getTitle()).to.eventually.equal('Title: New title');
  });
