var Collapsible = require('../components/collapsible/collapsible.js').Collapsible
...
describe('Region', () => {
  it('should show first two regions as expanded if collapsibleRegions is true', () => {
    ...
    var collapsible1 = new Collapsible('#region1field-wrapper .collapsible');
    ...
    var collapsible2 = new Collapsible('#region1field-wrapper .collapsible');
  ...
  it('should show third region as collapsed if collapsibleRegions is true', () => {
    ...
    var collapsible3 = new Collapsible('#region3field-wrapper .collapsible');
  ...
  it('should show/hide region names', () => {
    ...
    var firstRegion = element(by.id('region1field-wrapper'));
    expect(firstRegion.$('.panel-heading').isDisplayed()).to.eventually.be.true;

    var collapsible = new Collapsible('#region1field-wrapper .collapsible');
