...
exports.config = {
  ...
  onPrepare: function () {
    ...
    var originalWait = browser.wait.bind(browser);
    ...
    var browserGet = browser.get.bind(browser);
    var params = {
    ...
    browser.get = function (url) {
      ...
      var baseUrl = url.substring(0, hasAnchor ? url.indexOf('#') : url.length);
      var anchors = '';
      if (hasAnchor) {
      ...
      var paramsKeysLen = Object.keys(params).length;
      for (var i = 0; i < paramsKeysLen; i++) {
  ...
  onComplete: function () {
    // print browser error logs into protractor console
