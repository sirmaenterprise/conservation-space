...
export class Translate {
  constructor(translateService, dateService, $scope) {
    ...
    // Translate label instantly and bind it to controller variable. On language change this label will be reevaluated.
    ...
    this.translateService.translateInstant('homepage', $scope, this, 'homepage');
    ...
    this.translateService.translate('menu', $scope, this, 'menu');
    ...
    this.dateService.formatDate(new Date('July 10, 2015 11:13:00'), DateService.FULL_DATE, $scope, this, 'aDate');
    this.dateService.formatDate(new Date('October 13, 2014 11:13:00'), DateService.FULL_DATE, $scope, this, 'anotherDate');
    this.dateService.formatDate(new Date('June 6, 1983 03:00:00'), DateService.FULL_DATE, $scope, this, 'yetAnotherDate');
  }
