...
function bootstrapSandbox(configuration) {
  ...
  paths['services/rest/libraries-service'] = 'sandbox/services/rest/libraries-service.stub.js';
  ...
  paths['services/rest/external-search-service'] = 'sandbox/services/rest/external-search-service.stub.js';
  ...
  Promise.all(importPromises).then(function () {
    ...
    angular.element(document).ready(function () {
      // only if other module has not bootstrapped it yet (e.g. main.jsi)
