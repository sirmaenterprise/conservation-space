...
describe('AdvancedSearchNumericCriteria', () => {
  ...
  beforeEach(() => {
    ...
    AdvancedSearchNumericCriteria.prototype.config = undefined;

    criteria = AdvancedSearchMocks.getCriteria().rules[0];
    AdvancedSearchNumericCriteria.prototype.criteria = criteria;
  ...
  afterEach(() => {
    // Fix scope mixing issue in karma
    AdvancedSearchNumericCriteria.prototype.criteria = undefined;
    AdvancedSearchNumericCriteria.prototype.config = undefined;
  });
