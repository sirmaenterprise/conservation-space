import {BpmReleaseAction} from 'idoc/actions/bpm-release-action';
import {BpmMockUtil} from 'test/idoc/actions/bpm-mock-util';

describe('BpmReleaseAction ', () => {
  ...
  beforeEach(() => {
    ...
    bpmTransitionHandler = new BpmReleaseAction(actionService, validationService, saveDialogService, instanceRestService, eventbus, logger, promiseAdapter, bpmService, translateService, notificationService);
    context = {
      currentObject: {
        getId: () => {
          return 'emf:id'
