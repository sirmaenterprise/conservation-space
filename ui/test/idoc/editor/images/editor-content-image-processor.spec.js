import {EditorContentImageProcessor} from 'idoc/editor/images/editor-content-image-processor'
...
describe('EditorContentImageProcessor', function () {
  ...
  it('should set lazy image properties in edit mode', function () {
    var expected = '<div>The <img width="100" height="200" data-embedded-id="emf:630f886c-19d2-47ac-bcb8-9fc7872735f7" data-original="/remote/api/content/static/emf:630f886c-19d2-47ac-bcb8-9fc7872735f7?tenantId=tenant.com" data-cke-saved-src="/remote/api/content/static/emf:630f886c-19d2-47ac-bcb8-9fc7872735f7?tenantId=tenant.com"> is an old painting.</div>'
  ...
  it('should also set lazy image properties when image is not persisted', function () {
    var expected = '<div>The <img width="100" height="200" data-original="http://123.com/img.jpg"> is an old painting.</div>'
