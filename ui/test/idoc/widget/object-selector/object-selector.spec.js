...
import {SINGLE_SELECTION, MULTIPLE_SELECTION, NO_SELECTION} from 'search/search-selection-modes';
...
describe('ObjectSelector', () => {
  ...
  function getObjectSelectorInstance(scope) {
    ...
    return new ObjectSelector(scope, pickerService);
  }
