...
describe('PropertiesSelectorHelper', () => {
  ...
  it('getDefinitionsArray should remove any duplicates when the definitions are loaded', () => {
    var propertiesSelectorHelper = initSelectorHelper();
    ...
    var definitions = propertiesSelectorHelper.afterDefinitionsLoaded.getCall(0).args[1];
  ...
  it('removeSelectedProperties should remove missing definitions from selectedProperties map', () => {
    ...
    propertiesSelectorConfig.definitions = [{identifier: 'definitionId1'}, {identifier: 'definitionId3'}];
  ...
  describe('getSelectedPropertiesArray', () => {
    let models = {
    ...
    it('should return selected properties by definitionId', () => {
      let selectedPropertiesMap = {
        'ET220000': ['inputTextEdit'],
        'http://ittruse.ittbg.com/ontology/enterpriseManagementFramework#Project': ['inputTextPreview']
      };
      expect(PropertiesSelectorHelper.getSelectedPropertiesArray(models, selectedPropertiesMap)).to.eql(['inputTextEdit']);
    });
    ...
    it('should return selected properties by rdf type', () => {
      ...
      expect(PropertiesSelectorHelper.getSelectedPropertiesArray(models, selectedPropertiesMap)).to.eql(['inputTextPreview']);
    });

    it('should return selected properties by semantic hierarchy', () => {
      let selectedPropertiesMap = {
        'http://ittruse.ittbg.com/ontology/enterpriseManagementFramework#Activity': ['inputTextPreview']
      };
      expect(PropertiesSelectorHelper.getSelectedPropertiesArray(models, selectedPropertiesMap)).to.eql(['inputTextPreview']);
    });
  });
