...
describe('ContentViewerConfig', () => {
  ...
  var widgetConfig, objectSelectorHelper;
  ...
  beforeEach(() => {
    ...
    widgetConfig = new ContentViewerConfig(objectSelectorHelper, mockConfigurations());
  });
  ...
  it('should update object selection mode', () => {
    ...
    var onSelectorChangedPayload = getOnSelectorChangedPayload('select-mode');
  ...
  it('should update search criteria', () => {
    ...
    var criteria = {condition: 'OR', rules: []};
    var onSelectorChangedPayload = getOnSelectorChangedPayload('select-mode', criteria);
    widgetConfig.onObjectSelectorChanged(onSelectorChangedPayload);
  ...
  it('should retrieve selected item when selecting manually', () => {
    widgetConfig.config.selectedObject = 'ni';
    var onSelectorChangedPayload = getOnSelectorChangedPayload(SELECT_OBJECT_MANUALLY, {}, [{id: 'icky'}]);
    widgetConfig.onObjectSelectorChanged(onSelectorChangedPayload);
  ...
  it('should retrieve search item when selecting automatically', () => {
    widgetConfig.config.selectedObject = 'ni';
    var onSelectorChangedPayload = getOnSelectorChangedPayload(SELECT_OBJECT_AUTOMATICALLY, {}, [], [{id: 'Ptang'}]);
    widgetConfig.onObjectSelectorChanged(onSelectorChangedPayload);
  ...
  it('should retrieve the search mode', () => {
    ...
    var onSelectorChangedPayload = getOnSelectorChangedPayload('select-mode', {}, {}, {}, 'advanced');
    widgetConfig.onObjectSelectorChanged(onSelectorChangedPayload);
