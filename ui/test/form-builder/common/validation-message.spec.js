...
describe('ValidationMessage', () => {
  ...
  describe('ngOnInit', ()=> {
    ...
    it('should remove validation message when in preview mode and there are available messages', () => {
      validationMessage.validationModel.messages = [{
        'id': 'mandatory', 'level': 'error', 'message': 'The field is mandatory'
      }];
      ...
      validationMessage.ngOnInit();
      expect(htmlSpy.called,'method called when initialized in preview mode').to.be.true;
