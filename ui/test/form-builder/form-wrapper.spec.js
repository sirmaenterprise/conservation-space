...
describe('FormWrapper', () => {
  ...
  describe('when created', () => {
    ...
    it('should assign handler for AfterFormValidationEvent and to process model from currently validated object', () => {
      ...
      getBuilderInstance(IdocMocks.mockElement(), logger, $compile, $scope, pluginsService, validationService, eventbus, configuration);
      ...
      getBuilderInstance(IdocMocks.mockElement(), logger, $compile, $scope, pluginsService, validationService, eventbus, configuration);
      let spyHandler = sinon.spy(FormWrapper, 'filterFields');
  ...
  describe('#buildForm', () => {
    ...
    it('should render all fields if config.renderMandatory=false which is the default', () => {
      ...
      getBuilderInstance();
      formWrapper.buildForm(formViewModel.fields, buildValidationModel(), 'EDIT');
      let createdHtml = formWrapper.getHtml();
      expect(createdHtml).to.equal('<seip-region id="inputTextFields-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'inputTextFields\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"><seip-input-text id="field1-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field1\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field2-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field2\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field3-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field3\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field4-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field4\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field5-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field5\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field6-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field6\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text></seip-region>');
    });
    ...
    it('should add style attribute to controls if there is style provided in config', () => {
      ...
      getBuilderInstance();
      formWrapper.buildForm(formViewModel.fields[0].fields, buildValidationModel(), 'EDIT');
      let createdHtml = formWrapper.getHtml();
      expect(createdHtml).to.equal('<seip-input-text id="field1-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field1\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" ng-style="{ \'width\': \'100px;\' }" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field2-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field2\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" ng-style="{ \'width\': \'100px;\' }" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field3-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field3\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" ng-style="{ \'width\': \'100px;\' }" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field4-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field4\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" ng-style="{ \'width\': \'100px;\' }" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field5-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field5\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" ng-style="{ \'width\': \'100px;\' }" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text><seip-input-text id="field6-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field6\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" ng-style="{ \'width\': \'100px;\' }" flat-form-view-model="formWrapper.fieldsMap"></seip-input-text>');
    });
    ...
    it('should render fields with not supported control types as empty cells', () => {
      ...
      formWrapper.buildForm(formViewModel.fields, buildValidationModel(), 'EDIT');
      let createdHtml = formWrapper.getHtml();
      expect(createdHtml).to.equal('<seip-region id="inputTextFields-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'inputTextFields\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"><seip-empty-cell id="field2-wrapper" validation-model="formWrapper.formConfig.models.validationModel" field-view-model="::formWrapper.fieldsMap[\'field2\']" validation-service="::formWrapper.validationService" form="formWrapper.objectDataForm" widget-config="formWrapper.config" form-config="formWrapper.formConfig" object-id="formWrapper.formConfig.models.id" flat-form-view-model="formWrapper.fieldsMap"></seip-empty-cell></seip-region>');
    });
  ...
  describe('toggleConditions', () => {
    ...
    it('should enable all conditions', () => {
      let viewModel = new ViewModelBuilder()
        ...
        .addField('field3', 'EDITABLE', 'text', 'field 2', true, false, [{ 'id': 'mandatory' }, { 'id': 'condition', 'rules': [{ 'id': 'hidden', 'renderAs': 'hidden' }] }])
        .endRegion()
        .addField('field4', 'EDITABLE', 'text', 'field 3', true, false, [{ 'id': 'mandatory' }])
        .addField('field5', 'EDITABLE', 'text', 'field 4', true, false, [{ 'id': 'mandatory' }, { 'id': 'condition', 'rules': [{ 'id': 'hidden', 'renderAs': 'hidden' }] }])
        .getModel().serialize();
  ...
  describe('filterFields', () => {
    ...
    it('should filter mandatory fields if renderMandatory=true', () => {
      ...
      FormWrapper.filterFields(viewModel, renderMandatory, selectedProperties, renderAll, FormWrapper.FORM_VIEW_MODE_EDIT, validationModel, logger);
    ...
    it('should call filterSelectedFields with model and selectedProperties array if there are selected properties in preview and edit mode', () => {
      ...
      FormWrapper.filterFields(viewModel, renderMandatory, selectedProperties, renderAll, FormWrapper.FORM_VIEW_MODE_PREVIEW, validationModel, logger);
  ...
  describe('filterMandatoryFields', () => {
    it('should set rendered=true to all fields when all are mandatory', () => {
      let model = new ViewModelBuilder()
        .addField('field1', 'EDITABLE', 'text', 'field 1', true, false, [])
        .addField('field2', 'EDITABLE', 'text', 'field 2', true, false, [])
        .addField('field3', 'EDITABLE', 'text', 'field 3', true, false, [])
      ...
      let expectedModel = new ViewModelBuilder()
        ...
        .endRegion()
        .getModel();
      FormWrapper.filterMandatoryFields(model.fields);
      expect(model.serialize()).to.eql(expectedModel.serialize());
    });
  ...
  function getBuilderInstance(_element, _logger, _compile, _scope, _pluginsService, _validationService, _eventbus, _configuration) {
    let $scope = mock$scope();
    formWrapper = new FormWrapper(_element || IdocMocks.mockElement(), _logger || logger, _compile || $compile, $scope,
      _pluginsService || pluginsService, _validationService || validationService, _eventbus || eventbus, _configuration || configuration);
