...
describe('Instance Model', ()=> {
  ...
  var testData = {
    ...
    'emf:hasParent': {
      defaultValue: 'emf:f1be0ccc-fc91-41ed-b2a9-59d136a513ec',
      value: 'emf:f1be0ccc-fc91-41ed-b2a9-59d136a513ec',
      messages: []
    },
    lockedBy: {
      defaultValue: [{
        ...
        id: "emf:admin-georgi.com",
        instanceType: "user",
        properties: {
          'dcterms:description': 'admin@test.com'
        }
      }],
      messages: [],
      valid: true,
