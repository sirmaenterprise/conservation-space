...
describe('ActionsService', () => {
  ...
  it('exportPDF should perform post with proper arguments', () => {
    ...
    let expected = {operation: 'exportPDF', url: '/#/idoc/emf:123456?mode=print&jwt=jwtToken'};
    actionsService.exportPDF(id, null, data);
    expect(restClient.post.calledOnce);
    expect(restClient.post.getCall(0).args[0]).to.equal('/instances/emf:123456/actions/export-pdf');
