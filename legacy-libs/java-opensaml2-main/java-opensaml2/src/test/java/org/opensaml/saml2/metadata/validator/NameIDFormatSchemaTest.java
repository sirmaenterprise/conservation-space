...
public class NameIDFormatSchemaTest extends BaseSAMLObjectValidatorTestCase {
     ...
     */
    public void testFormatFailure() throws ValidationException {
        NameIDFormat nameIDFormat = (NameIDFormat) target;

        nameIDFormat.setFormat(null);
        assertValidationFail("Format was null, should raise a Validation Exception.");

        nameIDFormat.setFormat("");
        assertValidationFail("Format was empty string, should raise a Validation Exception.");

        nameIDFormat.setFormat("   ");
        assertValidationFail("Format was white space, should raise a Validation Exception.");
    }
}