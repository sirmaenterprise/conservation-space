...
<jsp:useBean id="helpBroker" class="javax.help.ServletHelpBroker"
	scope="session" />
<jsp:useBean id="sslUtil" class="com.sirma.itt.emf.help.SSLService" scope="application"/>	
<%
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	%>
	<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="images/user-guide-16.png" />
	...
	<frameset COLS="30%,70%" name="lowerhelp" BORDER=0 frameborder=NO>
		...
		<frameset rows="80,*" name="rightpane" framespacing=0>
			<frame NORESIZE SRC="toolbars.jsp" id="toolbarframe"
				name="toolbarframe" SCROLLING="NO" BORDER=0 frameborder=NO>
				<frame
