...
public interface AuditExportService {
	 ...
	 */
	File exportAsCsv(List<AuditActivity> activities, String query, JSONArray columns)
	 ...
	 *             if a problem occurs while exporting
	 */
	File exportAsPdf(List<AuditActivity> activities, String query, JSONArray columns)
			throws IOException, JSONException;
}
