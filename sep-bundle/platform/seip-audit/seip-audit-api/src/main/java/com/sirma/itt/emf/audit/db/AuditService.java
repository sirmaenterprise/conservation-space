...
/**
 * The general service that combines the rdb and Solr services and provides one
...
public interface AuditService {
	...
	/**
	 * Retrieves the ids of the activities from Solr with the specified query
	 * and queries the relational database for the complete records with the
	 * given ids.
	 * 
	 * @param solrQuery
	 ...
	 */
	ServiceResult getActivitiesBySolrQuery(SolrQueryParams solrQuery)
			throws SolrServiceException;
}
