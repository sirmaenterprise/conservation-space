...
/**
 * Fired after the plugin registry is initialized. Provides the currently
 * fetched plugins so they could be modified based on custom logic.
 * 
 * @author Adrian Mitev
 */
public class AfterPluginRegistryInitializedEvent {
	 ...
	 */
	public AfterPluginRegistryInitializedEvent(
			Map<String, List<Bean<?>>> plugins) {
