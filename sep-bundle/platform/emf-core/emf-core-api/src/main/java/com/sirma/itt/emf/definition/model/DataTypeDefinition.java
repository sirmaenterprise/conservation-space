 ...
 */
public interface DataTypeDefinition extends Entity<Long> {
	//
	...
	Set<String> DEFAULT_TYPES = new LinkedHashSet<>(Arrays.asList(ANY, BOOLEAN, DATE, DATETIME,
			DOUBLE, FLOAT, INSTANCE, INT, LONG, TEXT, URI));
