 ...
 */
public interface CMFRenditionAdapterService extends CMFAdapterService {
	...
	/**
	 * Download thumbnail for provided instance dms id. The result is stored in the provided buffer.
	 * Supported are only 'content' instances like documents
	 *
	 * @param dmsId
	 *            the dms id for node
	 * @param buffer
