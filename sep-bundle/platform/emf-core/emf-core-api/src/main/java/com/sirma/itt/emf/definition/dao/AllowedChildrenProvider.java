...
public interface AllowedChildrenProvider<I extends Instance> {
	...
	/**
	 * Gets the active instance based on the parent instance and the concrete child type. The method
	 * is called only when {@link #calculateActive(Instance, String)} returns <code>true</code> for
	 * the same arguments.
	 * 
	 * @param <A>
