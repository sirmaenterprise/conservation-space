...
/**
 * Instance class that represents a link. The link has a beginning and an end and primary direction.
 * It can have a reverse with the same or different link identifier which is non primary link. The
 * primary direction is the direction when the link was created and which objects was the first and
