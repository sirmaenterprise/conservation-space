...
/**
 * Comparator for property model. The sorting is done by comparing one specific
 * field.
 * <p>
...
public class PropertyModelComparator implements Comparator<PropertyModel> {
	...
	private int compareProps(Map<String, Serializable> props1, Map<String, Serializable> props2,
			String key) {
		...
		throw new EmfRuntimeException("Cannot compare values of different types "
