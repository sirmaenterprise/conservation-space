...
/**
 * Exception thrown by methods that wait time for some condition to occur but the condition is never
 * met and they cannot continue correctly their execution or wait indefinitely.
 * 
 * @author BBonev
 */
