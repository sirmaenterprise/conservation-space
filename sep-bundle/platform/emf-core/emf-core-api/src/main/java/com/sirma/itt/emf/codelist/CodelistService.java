...
public interface CodelistService {
	...
	/**
	 * Gets the code values for the given codelist number. The method can optionally sort the
	 * results by their description.
	 * 
	 * @param codelist
	 *            the codelist
	 * @param sorted
	...
	/**
	 * Gets the description for the given codelist and code value based on the current default
	 * locale.
	 * 
	 * @param codelist
	 *            the codelist
	 * @param value
	 *            the value
	 * @return The description according to locale. This may return null in cases where the codelist
	 *         is null or there is not such codelist in cache or there is no value found in the
	 *         codelist for the key.
	 */
	 ...
	 * @return the filtered code values
	 */
	Map<String, CodeValue> getFilteredCodeValues(Integer codelist, boolean sorted,
			String... filterId);

	/**
	 * Gets the description from the given {@link CodeValue}. The description is determined based on
	 ...
	 * @return the description
	 */
	// String getDescription(CodeValue value, String language);
