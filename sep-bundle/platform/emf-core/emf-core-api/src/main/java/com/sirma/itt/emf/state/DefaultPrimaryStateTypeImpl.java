 ...
 * @author BBonev
 */
public class DefaultPrimaryStateTypeImpl implements PrimaryStateType, Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PrimaryStateType)) {
			return false;
		}
		PrimaryStateType other = (PrimaryStateType) obj;
		if (type == null) {
