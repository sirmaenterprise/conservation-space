...
public interface PropertyModelCallback<E extends PropertyModel> {
	...
	/**
	 * Gets the supported objects by this callback. The method should return the main model and all
	 * instance classes that are supported.
	 * 
	 ...
	 */
	PropertyModelKey createModelKey(Entity<?> baseEntity, Long revision);
	 ...
	 *            the properties
	 */
	void updateModel(Map<PropertyModelKey, Object> target,
