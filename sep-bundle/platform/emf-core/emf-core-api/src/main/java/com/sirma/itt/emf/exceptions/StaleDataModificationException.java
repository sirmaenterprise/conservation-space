...
/**
 * Exception thrown when the user tries to update data of an object/instance that already has been
 * updated by him or other user and he has a stale data.
 * 
 * @author BBonev
 */
public class StaleDataModificationException extends EmfApplicationException {
	 ...
	 *            the last modified on
	 */
	public StaleDataModificationException(String message, Serializable modifiedBy,
			Date lastModifiedOn) {
		super(message);
	 ...
	 * {@link com.sirma.itt.emf.resources.model.Resource} or <code>null</code> if unknown.
	 * 
