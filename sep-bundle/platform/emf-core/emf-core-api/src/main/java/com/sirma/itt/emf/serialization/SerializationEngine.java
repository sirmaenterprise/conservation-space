...
/**
 * Generic serialization engine. Provides methods for serialization between object and
 * serializable and reverse.
 *
 * @author BBonev
 */
public interface SerializationEngine {
	...
	/**
	 * Serialize the given object based on the concrete serialization engine. The object could
	 * be deserialized via {@link #deserialize(Serializable)} method.
	 *
	 * @param src
