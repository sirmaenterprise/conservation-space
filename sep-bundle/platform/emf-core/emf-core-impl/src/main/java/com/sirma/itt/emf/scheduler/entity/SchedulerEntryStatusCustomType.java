 ...
 * @author BBonev
 */
public class SchedulerEntryStatusCustomType implements UserType {
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names,
		...
		SchedulerEntryStatus displayType = SchedulerEntryStatus.valueOf(value);
		return displayType;
	}
		...
		if (null == value) {
			...
			if (value instanceof SchedulerEntryStatus) {
				...
				throw new IllegalArgumentException("Invalid field type. Must be "
						+ SchedulerEntryStatus.class + " but was " + value.getClass());
			}
		}
	}
