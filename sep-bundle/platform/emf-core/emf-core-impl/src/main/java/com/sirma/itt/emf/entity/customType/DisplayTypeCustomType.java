...
/**
 * Custom type for {@link DisplayType} enum.
 *
 * @author BBonev
 */
public class DisplayTypeCustomType implements UserType {
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names,
		...
		DisplayType displayType = DisplayType.parse(value);
		if (displayType == null) {
	...
	public void nullSafeSet(PreparedStatement preparedStatement, Object value, int index,
		...
		if (null == value) {
			...
			if (value instanceof DisplayType) {
				...
				preparedStatement.setString(index, type.toString().toLowerCase());
			} else {
				throw new IllegalArgumentException("Invalid field type. Must be "
						+ DisplayType.class + " but was " + value.getClass());
			}
		}
	}
