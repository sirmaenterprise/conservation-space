package com.sirma.itt.emf.io.descriptor;
...
/**
 * Resource file descriptor for files located into the current class loader and
 * can be retrieved by {@link Class#getResourceAsStream(String)}.
 * 
 * @author BBonev
 */
