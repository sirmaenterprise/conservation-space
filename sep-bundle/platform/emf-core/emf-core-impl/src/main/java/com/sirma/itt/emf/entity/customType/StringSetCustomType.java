 ...
 * @author BBonev
 */
public class StringSetCustomType implements UserType {
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names,
		...
		if (StringUtils.isNotNullOrEmpty(value)) {
			...
			list = new LinkedHashSet<Object>(Arrays.asList(values));
		}
		return list;
	}
		...
		if (null == value) {
			...
			if (value instanceof Set) {
				...
				throw new IllegalArgumentException(
						"Invalid field type. Must be java.util.List but was " + value.getClass());
			}
		}
	}
