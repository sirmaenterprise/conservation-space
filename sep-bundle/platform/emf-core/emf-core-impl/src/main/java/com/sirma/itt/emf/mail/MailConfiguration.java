...
public class MailConfiguration {
	...
	/**
	 * Constructor initializing the configuration protocol. One of the constants
	 * {@value #SMTP_PROTOCOL} or {@value #SMTPS_PROTOCOL} must be passed.
	 * 
	 * @param protocol
	...
	/**
	 * Sets a property value for the specified property key. The key format must be as the format of
	 * the defined properties in the class. The key must not include the protocol.
	 * 
	 * @param key
