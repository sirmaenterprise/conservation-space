...
/**
 * Exception mapper for all kind of exceptions. Returns an object containing the default EMF error
 * message.
 * 
 * @author Adrian Mitev
 */
...
public class RestExceptionHandler implements ExceptionMapper<Exception> {
	...
	public Response toResponse(Exception exception) {
		...
		return Response.serverError().type(MediaType.APPLICATION_JSON).entity(object.toString())
				.build();
	}
