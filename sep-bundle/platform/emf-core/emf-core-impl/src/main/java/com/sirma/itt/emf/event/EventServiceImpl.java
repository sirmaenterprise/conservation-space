...
public class EventServiceImpl implements EventService {
	 ...
	 */
	private Annotation[] removeNullQualifiers(Annotation... qualifiers) {
		if ((qualifiers != null) && (qualifiers.length > 0)) {
			List<Annotation> list = new ArrayList<Annotation>(qualifiers.length);
	 ...
	 *            the qualifiers
	 */
	private void registerQualifiers(EmfEvent event, Annotation... qualifiers) {
