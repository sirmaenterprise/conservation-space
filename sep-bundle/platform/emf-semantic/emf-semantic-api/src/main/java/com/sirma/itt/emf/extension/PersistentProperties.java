...
/**
 * List of properties that need to be persisted without 
 * definition in an {@link Instance} property map
 * 
...
public class PersistentProperties implements PersistentPropertiesExtension {
	...
	private static final Set<String> ALLOWED_NO_DEFINITION_FIELDS = PersistentPropertyKeys.getAllPersistentPropertyKeys();
