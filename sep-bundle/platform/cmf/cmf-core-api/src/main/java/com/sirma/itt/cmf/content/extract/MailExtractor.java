...
public interface MailExtractor<T> extends Plugin {
	 ...
	 * {@link #PART_ATTACHMENTS} is provided as argument, all attachment will be returned as list
	 * keyed with {@link #PART_ATTACHMENTS}
	 * 
	 * @param descriptor
	 *            the mail to parse
	 * @param deletedata
	 ...
	 * @return the map keyed by the mail part and the processed value. {@link #PART_ATTACHMENTS} is
	 *         provided only attachments are extracted and returned.
	 */
	Map<String, Object> extractMail(FileDescriptor descriptor, boolean deletedata,
			File tempDir, String prefix, String... mailParts);
