...
public class VersionInfo implements Serializable {
	 ...
	 *            the version creator
	 */
	public VersionInfo(String versionLabel, String versionName, String versionDescription,
			Date versionDate, String versionCreator) {
	 ...
	 *            the version description
	 */
	public VersionInfo(DocumentInstance docInstance, String versionLabel, String versionName,
			Date versionDate, String versionCreator, String versionDescription) {
		super();
