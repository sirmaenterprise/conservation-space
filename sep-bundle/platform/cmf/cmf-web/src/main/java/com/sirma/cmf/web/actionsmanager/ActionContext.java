...
/**
 * When actions are requested for given instance, its context is first evaluated and restored if
 * possible. Then the target instance is stored here for later access.
 * 
 * @author svelikov
 */
@Named
...
public class ActionContext extends AbstractMap<String, Serializable> implements Serializable {
	...
	public void setActionTraget(Instance instance) {
		this.put("targetInstance", instance);
	}
	...
	public Instance getActionTarget() {
		return (Instance) this.get("targetInstance");
	}
