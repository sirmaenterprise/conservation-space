...
/**
 * navigation constants. REVIEW tozi class da se napravi na interface. Sled kato imeto na class-a e
 * NavigationConstants nqma nujda kym konstantite da se dobavq prefix NAVIGATE_ - primer
 * NAVIGATE_USER_DASHBOARD.
 * 
 * @author svelikov
 */
public class NavigationConstants {
	...
	/**
	 * When we should return back to a page where some action was executed (such case is the
	 * 'cancel' action).
	 */
