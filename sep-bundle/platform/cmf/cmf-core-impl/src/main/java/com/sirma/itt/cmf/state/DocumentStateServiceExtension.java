 ...
 * case.
 * <p>
 * <b>NOTE</b>: this extension is disabled if objects module is present. Due to the fact that
 * documents could be attached to an object and thus the actions calculations depends on the object
 * and not the case. Overridden by ObjectDocumentStateServiceExtension.
 * 
 * @author BBonev
 */
@ApplicationScoped
@InstanceType(type = ObjectTypesCmf.DOCUMENT)
@Extension(target = StateServiceExtension.TARGET_NAME, order = 14)
public class DocumentStateServiceExtension extends
