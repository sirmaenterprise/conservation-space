package com.sirma.itt.objects.domain.definitions.impl;
...
/**
 * Default Object definition implementation.
 * 
 * @author BBonev
 */
public class ObjectDefinitionImpl extends BaseRegionDefinition<ObjectDefinitionImpl> implements
		ObjectDefinition, MergeableTopLevelDefinition<ObjectDefinitionImpl> {
	/**
	 * Comment for serialVersionUID.
	 */
	private static final long serialVersionUID = 5121025007626134394L;
	/** The dms id. */
	@Tag(1)
	...
	public ObjectDefinitionImpl mergeFrom(ObjectDefinitionImpl source) {
