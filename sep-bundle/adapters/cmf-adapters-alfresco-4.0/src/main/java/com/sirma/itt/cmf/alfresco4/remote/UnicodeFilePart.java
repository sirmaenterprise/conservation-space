...
/**
 * File part that allows files with name that is encoded in a custom charset.
 * The default charset is UTF-8.
 *
 * @author BBonev
 */
public class UnicodeFilePart extends FilePart {
	private static final Log LOG = LogFactory.getLog(UnicodeFilePart.class);
	 ...
	 * @throws FileNotFoundException
	 */
	public UnicodeFilePart(String name, String fileName, File file)
			throws FileNotFoundException {
		super(name, fileName, file);
	}

	/**
	 * Creates a file part with a name and given part source with specified
	 ...
	 */
	public UnicodeFilePart(String name, PartSource partSource, String contentType,
			String charset) {
		super(name, partSource, contentType, charset);
	}

	/**
	 * Creates a file part with a name and given file with specified content
	 * type and charset
	 *
	 * @param name
	 *            is the name of the part
	 ...
	 * @throws FileNotFoundException
	 */
	public UnicodeFilePart(String name, File file, String contentType,
			String charset) throws FileNotFoundException {
		super(name, file, contentType, charset);
	}

	/**
	 * Creates a file part with a name and given file with custom name and
	 * specified content type and charset
	 *
	 * @param name
	 *            is the name of the part
	 * @param fileName
	...
	/**
	 * Returns the charset that will used for encoding the name of the
	 * initialized file
	 *
	...
	/**
	 * Sets the charset to be used when decoding the file name when sending it
	 * to the remote site
	 * 
