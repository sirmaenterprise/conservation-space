...
public abstract class FieldProcessor {
	 ...
	 * @return the pair
	 */
	public abstract Pair<String, Serializable> processToDMSPassed(PropertyDefinition definitionn,
	 ...
	 * @return the pair
	 */
	public Pair<String, Serializable> processToCMFPassed(PropertyDefinition definition,
			Serializable jsonValue, DMSTypeConverter dmsTypeConvertor) {
	 ...
	 * @return the pair
	 */
	public Pair<String, Serializable> processToCMFSkipped(PropertyDefinition definition,
			Serializable jsonValue, DMSTypeConverter dmsTypeConvertor) {
