...
public class CodeListServiceImplTest {
	...
	/**
	 * Executed before every test. Prepares test database, mock ups and clears hibernate's
	 * statistics.
	 * 
	 * @throws Exception
	...
	public void saveCodeList() throws CodeListException {
		...
		assertEquals("test", ((CodeList) result.getResults().get(0)).getDisplayType());
	...
	/**
	 * Tries to update a codelist that does not exist in the database, meaning there is no codelist
	...
	/**
	 * Tries to edit an expired code list, which is a code list with validTo date before the current
	 * date.
	 * 
	 * @throws CodeListException
	...
	/**
	 * Tests the retrieval of specific code lists by creating a complex criteria with tenant "123",
	 * values that begins with "2" and applies an offset of 2 results.
	 */
	@Test
	public void retrieveSpecific() {
		CodeListSearchCriteria criteria = new CodeListSearchCriteria();
		criteria.setTenantNames(Arrays.asList("123"));
	...
	/**
	 * Test the correct retrieving of code lists with an offset. Test for correct total number of
	...
	/**
	 * Test the correct retrieving of code lists with an offset which will load the last page. Test
	...
	/**
	 * Test the correct retrieving of code lists with an offset and limit. Test for correct total
	...
	private void setupMock() {
		...
		EasyMock.expect(codeListInstanceDao.saveEntity(EasyMock.anyObject(Entity.class)))
