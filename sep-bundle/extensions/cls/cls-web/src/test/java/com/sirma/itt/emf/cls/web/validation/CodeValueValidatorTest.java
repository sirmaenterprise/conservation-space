...
public class CodeValueValidatorTest {
	...
	public void testCreateCodeValueMissingFields() {
		...
		assertTrue(validationResult.get("codeListId") != null && validationResult.get("codeListId").equals("This field is required."));
	...
	public void testCreateCodeValueInvalidDates() {
		...
		assertTrue(validationResult.get("codeListId") != null && validationResult.get("codeListId").equals("This field is required."));
		assertTrue(validationResult.get("value") != null && validationResult.get("value").equals("This field is required."));
		assertTrue(validationResult.get("validFrom") != null && validationResult.get("validFrom").equals("Validity start date must be greater than current date."));
	...
	public void testCreateCodeValueInvalidCodeListId() {
		...
		EasyMock.expect(codeListService.getCodeValues(EasyMock.anyObject(CodeValueSearchCriteria.class))).andReturn(searchResultCV);
		...
		assertTrue(validationResult.get("codeListId") != null && validationResult.get("codeListId").equals("Code list with this ID does not exists."));
	}
	...
	public void testCreateCodeValueExistingCodeValue() {
		...
		assertTrue(!validationResult.isEmpty());
		assertEquals(validationResult.size(), 1);
		assertTrue(validationResult.get("value") != null && validationResult.get("value").equals("There is already a code value with the same ID."));
	}
	...
	public void testUpdateCodeValueNotExisting() {
		...
		assertTrue(!validationResult.isEmpty());
		assertEquals(validationResult.size(), 1);
		assertTrue(validationResult.get("value") != null && validationResult.get("value").equals("There is no value with this ID in this code list."));
	}
