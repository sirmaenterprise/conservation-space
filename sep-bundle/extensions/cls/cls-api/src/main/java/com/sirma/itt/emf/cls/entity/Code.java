...
/**
 * POJO representing a code in CLS. A code is an object containing all the common fields contained
 * both in code lists and code values.
 * 
...
public abstract class Code {
	...
	@Column(length = 255, name = "EXTRA1")
	private String extra1;

	/** The code's second extra. */
	@Column(length = 255, name = "EXTRA2")
	private String extra2;

	/** The code's third extra. */
	@Column(length = 255, name = "EXTRA3")
	private String extra3;

	/** The code's fourth extra. */
	@Column(length = 255, name = "EXTRA4")
	private String extra4;

	/** The code's fifth extra. */
	@Column(length = 255, name = "EXTRA5")
