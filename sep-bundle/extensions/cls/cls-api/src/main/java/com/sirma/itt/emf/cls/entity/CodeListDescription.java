...
/**
 * Entity POJO representing a code list description. Extends {@link Description} where the common
 * attributes are defined. This class is used only to split the Descriptions table into two tables -
 * one for code lists and one for code values. Both tables have the same fields.<br>
