...
public class MSGParser extends BaseMailExtractor<MAPIMessage> {
	...
	protected void postExtract(FileDescriptor descriptor,
			Pair<MAPIMessage, String> openedMessage, boolean deleteParts) throws IOException {
		if (deleteParts) {
	 ...
	 */
	@Override
	protected void extractAttachments(Pair<MAPIMessage, String> message, String prefix,
			File tempStoreDir, boolean deleteParts, List<File> attachmentList) throws IOException {
		// just in case
		if (prefix == null) {
			prefix = "";
		}
